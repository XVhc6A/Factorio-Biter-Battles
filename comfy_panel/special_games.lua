...
local valid_special_games = {
	...
	disabled_research = {
		name = {
			...
			tooltip = "Disables choosen technologies from being researched",
		},
		config = {
			[1] = {
				name = "team",
	...
	disabled_entities = {
		name = {
			type = "label",
			caption = "Disabled entities",
			tooltip = "Disables choosen entities from being placed",
		},
		config = {
			[1] = {
				name = "team",
...
function Public.reset_active_special_games()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:117')
	for _, i in ipairs(global.active_special_games) do
		i = false
	end
end
function Public.reset_special_games_variables()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:122')
	global.special_games_variables = {}
end

local function generate_turtle(moat_width, entrance_width, size_x, size_y)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:126')
...
local function generate_infinity_chest(separate_chests, operable, gap, eq)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:181')
	local surface = game.surfaces[global.bb_surface_name]
...
local function generate_disabled_research(team, eq)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:232')
	...
	if tab[team] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:254')
		return
	end
...
local function reset_disabled_research(team)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:269')
	if not global.active_special_games["disabled_research"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:271')
		return
	end
	local tab = {
		["left"] = "north",
	...
	if tab[team] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:283')
		return
	else
...
local function generate_disabled_entities(team, eq)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:297')
...
local function on_built_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:330')
	if not global.active_special_games["disabled_entities"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:332')
		return
	end
...
local create_special_games_panel = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:344')
	frame.clear()
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:364')
	local player = game.get_player(event.player_index)
	local element = event.element
	if not element.type == "button" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:368')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/special_games.lua:461')
return Public

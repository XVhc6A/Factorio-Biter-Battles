...
function Public.get_table()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:23')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:24')
	return this
end

function Public.init_player_table(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:27')
	if not player then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:29')
		return
	end
...
local function get_score_list(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:47')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:62')
	return score_list
end

local function get_sorted_list(method, column_name, score_list)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:65')
	local comparators = {
		["ascending"] = function(a, b)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:67')
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:68')
			return a[column_name] < b[column_name]
		end,
		["descending"] = function(a, b)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:70')
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:71')
			return a[column_name] > b[column_name]
		end,
	}
	table.sort(score_list, comparators[method])
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:75')
	return score_list
end
...
local function get_total_biter_killcount(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:88')
	local count = 0
	for _, biter in pairs(biters) do
		count = count + force.kill_count_statistics.get_input_count(biter)
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:93')
	return count
end

local function add_global_stats(frame, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:96')
...
local show_score = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:129')
	frame.clear()
...
local function refresh_score_full()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:226')
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:237')
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:251')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:253')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:256')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:259')
		return
	end
	...
	local frame = Tabs.comfy_panel_get_active_frame(player)
	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:265')
		return
	end
	if frame.name ~= "Scoreboard" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:268')
		return
	end
	...
	if name == "show_floating_killscore_texts" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:276')
		return
	end
	...
	if column then
		...
		show_score(player, frame)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:296')
		return
	end
...
local function on_rocket_launched(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:302')
	refresh_score_full()
end
...
local function train_type_cause(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:327')
	local players = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:334')
	return players
end

local kill_causes = {
	["character"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:338')
		if not event.cause.player then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:340')
			return
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:342')
		return { event.cause.player }
	end,
	["combat-robot"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:344')
		if not event.cause.last_user then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:346')
			return
		end
		if not game.players[event.cause.last_user.index] then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:349')
			return
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:351')
		return { game.players[event.cause.last_user.index] }
	end,
	["car"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:353')
		local players = {}
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:367')
		return players
	end,
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:375')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:377')
		return
	end
	if not event.cause then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:380')
		return
	end
	if not event.cause.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:383')
		return
	end
	if event.entity.force.index == event.cause.force.index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:386')
		return
	end
	if not entity_score_values[event.entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:389')
		return
	end
	if not kill_causes[event.cause.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:392')
		return
	end
	local players_to_reward = kill_causes[event.cause.type](event)
	if not players_to_reward then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:396')
		return
	end
	if #players_to_reward == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:399')
		return
	end
...
local function on_player_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:416')
	local player = game.players[event.player_index]
	Public.init_player_table(player)
	local score = this.score_table[player.force.name].players[player.name]
...
local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:423')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:425')
		return
	end
	if building_and_mining_blacklist[event.entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:428')
		return
	end
...
local function on_built_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:437')
	if not event.created_entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:439')
		return
	end
	if building_and_mining_blacklist[event.created_entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:442')
		return
	end
	local player = game.players[event.player_index]
	Public.init_player_table(player)
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/score.lua:460')
return Public

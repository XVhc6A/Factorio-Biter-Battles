...
local function admin_only_message(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:10')
...
local function jail(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:18')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:20')
...
local function free(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:25')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:27')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
...
local function bring_player(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:38')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:40')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
	if player.driving == true then
		source_player.print("Target player is in a vehicle, teleport not available.", { r = 0.88, g = 0.88, b = 0.88 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:44')
		return
	end
...
local function go_to_player(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:64')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:66')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
...
local function spank(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:82')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:84')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
...
local function damage(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:100')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:102')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
	if player.character then
		if player.character.health > 1 then
...
local function kill(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:124')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:126')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
	if player.character then
...
local function enemy(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:139')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:141')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
...
local function ally(player, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:154')
	if player.name == source_player.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:156')
		return player.print("You can't select yourself!", { r = 1, g = 0.5, b = 0.1 })
	end
...
local function turn_off_global_speakers(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:163')
	local counter = 0
	...
	if counter == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:176')
		return
	end
	if counter == 1 then
...
local function delete_all_blueprints(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:185')
	local counter = 0
	for _, surface in pairs(game.surfaces) do
	...
	if counter == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:194')
		return
	end
	if counter == 1 then
...
local function create_mini_camera_gui(player, caption, position, surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:204')
...
local function filter_brackets(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:221')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:222')
	return (string.find(str, "%[") ~= nil)
end

local function match_test(value, pattern)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:225')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:226')
	return lower(value:gsub("-", " ")):find(pattern)
end

local function contains_text(key, value, search_text)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:229')
	if filter_brackets(search_text) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:231')
		return false
	end
	if value then
		if not match_test(key[value], search_text) then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:235')
			return false
		end
	else
		if not match_test(key, search_text) then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:239')
			return false
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:242')
	return true
end

local function draw_events(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:245')
	...
	if game.players[target_player_name] then
		if not history_index or not history_index[history] or #history_index[history] <= 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:278')
			return
		end
...
local function text_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:317')
	local element = event.element
	if not element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:320')
		return
	end
	if not element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:323')
		return
	end
	...
	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:331')
		return
	end
	if frame.name ~= "Admin" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:334')
		return
	end
...
local create_admin_panel = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:346')
	local antigrief = AntiGrief.get()
	frame.clear()
	...
	if #histories == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:481')
		return
	end
	...
	local drop_down_2 = frame.add({
		type = "drop-down",
		name = "admin_history_select",
		items = histories,
...
local function get_surface_from_string(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:534')
	if not str then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:536')
		return
	end
	if str == "" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:539')
		return
	end
	...
	if not surface then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:546')
		return false
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:549')
	return surface
end

local function get_position_from_string(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:552')
	if not str then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:554')
		return
	end
	if str == "" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:557')
		return
	end
	str = string.lower(str)
	...
	if not x_pos then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:563')
		return false
	end
	if not y_pos then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:566')
		return false
	end
	x_pos = x_pos + 2
	y_pos = y_pos + 2
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:600')
	return position
end

local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:603')
	local player = game.players[event.player_index]
	local frame = Tabs.comfy_panel_get_active_frame(player)
	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:607')
		return
	end

	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:611')
		return
	end
	...
	if name == "mini_camera" or name == "mini_cam_element" then
		player.gui.center["mini_camera"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:618')
		return
	end

	if frame.name ~= "Admin" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:622')
		return
	end
	...
	if admin_functions[name] then
		...
		if not target_player_name then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:628')
			return
		end
		if target_player_name == "Select Player" then
			player.print("No target player selected.", { r = 0.88, g = 0.88, b = 0.88 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:632')
			return
		end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:638')
		return
	end

	if admin_global_functions[name] then
		admin_global_functions[name](player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:643')
		return
	end

	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:647')
		return
	end
	if not event.element.caption then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:650')
		return
	end
	local position = get_position_from_string(event.element.caption)
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:654')
		return
	end

	local surface = get_surface_from_string(event.element.caption)
	if not surface then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:659')
		return
	end
	...
	if player.gui.center["mini_camera"] then
		if player.gui.center["mini_camera"].caption == event.element.caption then
			player.gui.center["mini_camera"].destroy()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:665')
			return
		end
	end
...
local function on_gui_selection_state_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:672')
	local player = game.players[event.player_index]
	local name = event.element.name
	...
	if name == "admin_history_select" then
		...
		local frame = Tabs.comfy_panel_get_active_frame(player)
		if not frame then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:684')
			return
		end
		if frame.name ~= "Admin" then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:687')
			return
		end
	...
	if name == "admin_player_select" then
		...
		local frame = Tabs.comfy_panel_get_active_frame(player)
		if not frame then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:700')
			return
		end
		if frame.name ~= "Admin" then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:703')
			return
		end
...
commands.add_command("kill", "Kill a player. Usage: /kill <name>", function(cmd)
	if not cmd.player_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:714')
		return
	end
	local killer = game.get_player(cmd.player_index)
	if not killer then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:718')
		return
	end
...
commands.add_command("punish", "Kill and ban a player. Usage: /punish <name> <reason>", function(cmd)
	if not cmd.player_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:736')
		return
	end
	local punisher = game.get_player(cmd.player_index)
	if not punisher then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/admin.lua:740')
		return
	end
	local t = {}
	local message

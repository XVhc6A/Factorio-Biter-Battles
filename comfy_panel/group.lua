...
local build_group_gui = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:18')
...
local function refresh_gui()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:139')
	for _, p in pairs(game.connected_players) do
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:164')
...
local function on_gui_text_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:176')
	local element = event.element
	if not element or not element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:179')
		return
	end
...
local function alphanumeric(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:197')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:198')
	return (string.match(str, "[^%w]") ~= nil)
end

local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:201')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:203')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:206')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:209')
		return
	end
	...
	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:216')
		return
	end
	if frame.name ~= "Groups" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:219')
		return
	end
		...
		if new_group_name ~= "" and new_group_name ~= "Name" and new_group_description ~= "Description" then
			if this.alphanumeric then
				if alphanumeric(new_group_name) then
					...
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:229')
					return
				end

				if alphanumeric(new_group_description) then
					player.print("Group description is not valid.", { r = 0.90, g = 0.0, b = 0.0 })
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:234')
					return
				end
			end
			...
			if string.len(new_group_name) > 64 then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:240')
				return
			end
			...
			if string.len(new_group_description) > 128 then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:245')
				return
			end
			...
			refresh_gui()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:266')
			return
		end
	end
	...
	if p then
		if p.name == "groups_table" then
			if event.element.type == "button" and event.element.caption == "Join" then
				...
				refresh_gui()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:292')
				return
			end
			...
			if event.element.type == "button" and event.element.caption == "Delete" then
				...
				refresh_gui()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:307')
				return
			end
			...
			if event.element.type == "button" and event.element.caption == "Leave" then
				...
				player.tag = ""
				refresh_gui()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:314')
				return
			end
		end
	end
...
function Public.alphanumeric_only(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:320')
	if value then
...
function Public.reset_groups()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:328')
	this.player_group = {}
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/group.lua:341')
return Public

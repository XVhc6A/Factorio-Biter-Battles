...
local function poll_id()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:66')
	local count = polls_counter[1] + 1
	polls_counter[1] = count
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:69')
	return count
end

local function apply_direction_button_style(button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:72')
...
local function apply_button_style(button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:83')
	local button_style = button.style
...
local function do_remaining_time(poll, remaining_time_label)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:94')
	local end_tick = poll.end_tick
	if end_tick == -1 then
		remaining_time_label.caption = "Endless Poll."
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:98')
		return true
	end
	...
	if ticks < 0 then
		...
		polls.running = false
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:105')
		return false
	else
		local time = math.ceil(ticks / 60)
		remaining_time_label.caption = "Remaining Time: " .. time
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:109')
		return true
	end
end

local function send_poll_result_to_discord(poll)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:113')
...
local function redraw_poll_viewer_content(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:155')
	...
	if not poll then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:168')
		return
	end
...
local function update_poll_viewer(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:299')
...
local function draw_main_frame(left, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:325')
	local trusted = session.get_trusted_table()
...
local function remove_create_poll_frame(create_poll_frame, player_index)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:407')
...
local function remove_main_frame(main_frame, left, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:417')
...
local function toggle(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:431')
...
local function update_duration(slider)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:444')
...
local function redraw_create_poll_content(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:460')
...
local function draw_create_poll_frame(parent, player, previous_data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:543')
...
local function show_new_poll(poll_data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:640')
	local message =
...
local function create_poll(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:667')
	...
	if not question:find("%S") then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:676')
		return
	end
	...
	if #answers < 1 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:690')
		return
	end
...
local function update_vote(voters, answer, direction)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:728')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:740')
	return tostring(count), table.concat(tooltip, ", ")
end

local function vote(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:743')
	...
	if previous_vote_answer == answer then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:756')
		return
	end
...
local function player_joined(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:805')
	local player = Game.get_player_by_index(event.player_index)
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:808')
		return
	end
...
local function tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:835')
	if not polls.running then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:837')
		return
	end
	for _, p in pairs(game.connected_players) do
		local frame = p.gui.left[main_frame_name]
...
Gui.on_click(create_poll_add_answer_name, function(event)
	...
	if not data then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:926')
		return
	end

	if data and #data.answers > 10 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:930')
		return
	end
...
Gui.on_click(create_poll_delete_name, function(event)
	...
	if not removed_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:982')
		return
	end
...
Gui.on_click(create_poll_edit_name, function(event)
	...
	if not new_question:find("%S") then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1016')
		return
	end
	...
	if not next(new_answers) then
		player.print("Sorry, the poll needs at least one answer.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1038')
		return
	end
...
local function do_direction(event, sign)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1128')
	local count
	if event.shift then
		count = #polls
	else
...
function Class.reset()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1158')
...
function Class.get_no_notify_players()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1179')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1180')
	return no_notify_players
end

function Class.validate(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1183')
	if type(data) ~= "table" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1185')
		return false, "argument must be of type table"
	end

	local question = data.question
	if type(question) ~= "string" or question == "" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1190')
		return false, "field question must be a non empty string."
	end

	local answers = data.answers
	if type(answers) ~= "table" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1195')
		return false, "answers field must be an array."
	end

	if #answers == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1199')
		return false, "answer array must contain at least one entry."
	end

	for _, a in pairs(answers) do
		if type(a) ~= "string" or a == "" then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1204')
	...
	if duration_type == "number" then
		if duration < 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1212')
			return false, "duration cannot be negative, set duration to 0 for endless poll."
		end
	elseif duration_type ~= "nil" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1215')
		return false, "duration must be of type number or nil"
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1218')
	return true
end

function Class.poll(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1221')
	local suc, error = Class.validate(data)
	if not suc then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1224')
		return false, error
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1268')
	return true, id
end

function Class.poll_result(id)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1271')
	if type(id) ~= "number" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1273')
	...
	for _, poll_data in pairs(polls) do
		if poll_data.id == id then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1292')
			return table.concat(result)
		end
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1296')
	return table.concat({ "poll #", id, " not found" })
end

function Class.send_poll_result_to_discord(id)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1299')
	if type(id) ~= "number" then
		Server.to_discord_embed("poll-id must be a number")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1302')
		return
	end
	...
	for _, poll_data in pairs(polls) do
		if poll_data.id == id then
			send_poll_result_to_discord(poll_data)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1308')
			return
		end
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/poll.lua:1316')
return Class

...
local function get_formatted_playtime(x)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:177')
	if x < 5184000 then
		local y = x / 216000
		y = tostring(y)
		local h = ""
		...
		if h == "0" then
			local str = m .. " minutes"
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:199')
			return str
		else
			local str = h .. " hours "
			str = str .. m
			str = str .. " minutes"
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:204')
			return str
		end
	else
		local y = x / 5184000
		...
		if h == "0" then
			local str = m .. " days"
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:227')
			return str
		else
			local str = h .. " days "
			str = str .. m
			str = str .. " hours"
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:232')
			return str
		end
	end
end
...
local function get_rank(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:237')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:322')
	return ranks[m]
end

local comparators = {
	["pokes_asc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:326')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:327')
		return a.pokes > b.pokes
	end,
	["pokes_desc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:329')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:330')
		return a.pokes < b.pokes
	end,
	["total_time_played_asc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:332')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:333')
		return a.total_played_ticks < b.total_played_ticks
	end,
	["total_time_played_desc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:335')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:336')
		return a.total_played_ticks > b.total_played_ticks
	end,
	["time_played_asc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:338')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:339')
		return a.played_ticks < b.played_ticks
	end,
	["time_played_desc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:341')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:342')
		return a.played_ticks > b.played_ticks
	end,
	["name_asc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:344')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:345')
		return a.name:lower() < b.name:lower()
	end,
	["name_desc"] = function(a, b)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:347')
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:348')
		return a.name:lower() > b.name:lower()
	end,
}

local function get_comparator(sort_by)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:352')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:353')
	return comparators[sort_by]
end

local function get_sorted_list(sort_by)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:356')
	local play_table = Session.get_session_table()
	local player_list = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:382')
	return player_list
end

local function player_list_show(player, frame, sort_by)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:385')
	-- Frame management
	frame.clear()
	...
	local header_modifier = {
		["name_asc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:417')
			h[2] = symbol_asc .. h[2]
		end,
		["name_desc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:420')
			h[2] = symbol_desc .. h[2]
		end,
		["total_time_played_asc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:423')
			h[3] = symbol_asc .. h[3]
		end,
		["total_time_played_desc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:426')
			h[3] = symbol_desc .. h[3]
		end,
		["time_played_asc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:429')
			h[4] = symbol_asc .. h[4]
		end,
		["time_played_desc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:432')
			h[4] = symbol_desc .. h[4]
		end,
		["pokes_asc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:435')
			h[5] = symbol_asc .. h[5]
		end,
		["pokes_desc"] = function(h)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:438')
			h[5] = symbol_desc .. h[5]
		end,
	}
	...
	for i = 1, #player_list, 1 do
		...
		if not p or not p.valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:519')
			return
		end
		...
		name_label.style.font_color = {
			r = 0.4 + p_color.color.r * 0.6,
			g = 0.4 + p_color.color.g * 0.6,
			b = 0.4 + p_color.color.b * 0.6,
		}
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:577')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:579')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:582')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:585')
		return
	end
	if not event.element.name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:588')
		return
	end
	...
	if not frame then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:594')
		return
	end
	if frame.name ~= "Players" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:597')
		return
	end
	...
	local actions = {
		["player_list_panel_header_2"] = function()
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:602')
		...
		["player_list_panel_header_3"] = function()
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:609')
			if string.find(event.element.caption, symbol_desc) then
		...
		["player_list_panel_header_4"] = function()
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:616')
			if string.find(event.element.caption, symbol_desc) then
		...
		["player_list_panel_header_5"] = function()
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:623')
			if string.find(event.element.caption, symbol_desc) then
	...
	if actions[name] then
		actions[name]()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:634')
		return
	end

	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:638')
		return
	end
	...
	if index and game.players[index] and index == game.players[index].index then
		...
		if not target or not target.valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:645')
			return
		end
	...
	if string.sub(event.element.name, 1, 11) == "poke_player" then
		...
		if player.name == poked_player then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:653')
			return
		end
...
local function refresh()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:672')
	for _, player in pairs(game.connected_players) do
		local frame = Tabs.comfy_panel_get_active_frame(player)
		if frame then
			if frame.name ~= "Players" then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:677')
				return
			end
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:684')
...
local function on_player_left_game()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:693')
	refresh()
end
...
function Public.show_roles_in_list(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:699')
	if value then
		this.show_roles_in_list = value
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:704')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/player_list.lua:713')
return Public

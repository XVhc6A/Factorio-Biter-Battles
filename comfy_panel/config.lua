...
local function get_actor(event, prefix, msg, admins_only)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:13')
	local player = game.get_player(event.player_index)
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:16')
		return
	end
	if admins_only then
...
local function spaghett_deny_building(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:25')
	local spaghett = global.comfy_panel_config.spaghett
	if not spaghett.enabled then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:28')
		return
	end
	local entity = event.created_entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:32')
		return
	end
	if not spaghett_entity_blacklist[event.created_entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:35')
		return
	end
...
local function spaghett()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:55')
	local spaghett = global.comfy_panel_config.spaghett
...
local function trust_connected_players()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:76')
...
local functions = {
	["comfy_panel_spectator_switch"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:92')
	...
	["comfy_panel_auto_hotbar_switch"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:99')
		if event.element.switch_state == "left" then
	...
	["comfy_panel_blueprint_toggle"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:106')
		if event.element.switch_state == "left" then
			game.permissions
				.get_group("Default")
	...
	["comfy_panel_spaghett_toggle"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:121')
		if event.element.switch_state == "left" then
	...
	["bb_team_balancing_toggle"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:131')
		if event.element.switch_state == "left" then
	...
	["bb_only_admins_vote"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:141')
		if event.element.switch_state == "left" then
...
local poll_function = {
	["comfy_panel_poll_trusted_toggle"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:154')
		if event.element.switch_state == "left" then
	...
	["comfy_panel_poll_no_notify_toggle"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:163')
...
local antigrief_functions = {
	["comfy_panel_disable_antigrief"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:175')
		local AG = Antigrief.get()
		if event.element.switch_state == "left" then
			AG.enabled = true
...
local fortress_functions = {
	["comfy_panel_disable_fullness"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:189')
	...
	["comfy_panel_offline_players"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:200')
	...
	["comfy_panel_collapse_grace"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:211')
		local WPT = package.loaded["maps.mountain_fortress_v3.table"]
		local this = WPT.get()
		if event.element.switch_state == "left" then
	...
	["comfy_panel_spill_items_to_surface"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:226')
		local WPT = package.loaded["maps.mountain_fortress_v3.table"]
		local this = WPT.get()
		if event.element.switch_state == "left" then
	...
	["comfy_panel_void_or_tile"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:245')
		local WPT = package.loaded["maps.mountain_fortress_v3.table"]
		local this = WPT.get()
		if event.element.switch_state == "left" then
	...
	["comfy_panel_trusted_only_car_tanks"] = function(event)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:256')
		local WPT = package.loaded["maps.mountain_fortress_v3.table"]
		local this = WPT.get()
		if event.element.switch_state == "left" then
...
local function add_switch(element, switch_state, name, description_main, description)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:269')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:297')
	return switch
end

local build_config_gui = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:300')
	local AG = Antigrief.get()
	local switch_state
	local label
...
local function on_gui_switch_state_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:603')
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:605')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:608')
		return
	end
	if functions[event.element.name] then
		functions[event.element.name](event)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:612')
		return
	elseif antigrief_functions[event.element.name] then
		antigrief_functions[event.element.name](event)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:615')
		return
	elseif fortress_functions[event.element.name] then
		fortress_functions[event.element.name](event)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:618')
		return
	elseif package.loaded["comfy_panel.poll"] then
		if poll_function[event.element.name] then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:622')
			return
		end
	end
end
...
local function on_force_created()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:627')
	spaghett()
end

local function on_built_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:631')
	spaghett_deny_building(event)
end

local function on_robot_built_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:635')
	spaghett_deny_building(event)
end

local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/comfy_panel/config.lua:639')

...
local function dot2(g, x, y)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:289')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:290')
	return x * g[1] + y * g[2]
end

local function dot(g, ...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:293')
	local v = { ... }
	local sum = 0
	for i = 1, #v do
		sum = sum + v[i] * g[i]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:299')
	return sum
end
...
function Simplex.d2(xin, yin, seed)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:305')
	xin = xin + seed
	yin = yin + seed
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:371')
	return 70.0 * (n0 + n1 + n2)
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/simplex_noise.lua:374')
return Simplex

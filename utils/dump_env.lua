...
local filter = function(item, path)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/dump_env.lua:14')
	if path[#path] ~= inspect.METATABLE and item ~= "package" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/dump_env.lua:16')
		return item
	end
end

local function player_joined(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/dump_env.lua:20')

...
local function borrow(tens, units, base)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:8')
	local frac = tens % 1
	units = units + frac * base
	tens = tens - frac
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:12')
	return tens, units
end

local function carry(tens, units, base)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:15')
	if units >= base then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:23')
	return tens, units
end

local function is_leap(y)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:26')
	if (y % 4) ~= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:28')
		return false
	elseif (y % 100) ~= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:30')
		return true
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:32')
		return (y % 400) == 0
	end
end
...
local function month_length(m, y)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:44')
	if m == 2 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:46')
		return is_leap(y) and 29 or 28
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:48')
		return mon_lengths[m]
	end
end

local function day_of_year(day, month, year)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:52')
	local yday = months_to_days_cumulative[month]
	if month > 2 and is_leap(year) then
		yday = yday + 1
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:57')
	return yday + day
end

local function leap_years_since(year)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:60')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:61')
...
local function normalise(year, month, day, hour, min, sec)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:66')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:117')
...
function Public.to_timetable(secs)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:123')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:124')
...
function Public.from_timetable(timetable)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:130')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:140')
...
function Public.to_string(secs)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:146')
	local tt = normalise(1970, 1, 1, 0, 0, secs)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:148')
	return strformat("%04u-%02u-%02u %02u:%02u:%02d", tt.year, tt.month, tt.day, tt.hour, tt.min, tt.sec)
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/timestamp.lua:151')
return Public

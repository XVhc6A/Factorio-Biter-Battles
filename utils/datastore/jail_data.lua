...
local validate_playtime = function(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:56')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:65')
	return playtime
end

local validate_trusted = function(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:68')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:77')
	return is_trusted
end

local get_player_data = function(player, remove)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:80')
	if remove and player_data[player.name] then
		player_data[player.name] = nil
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:83')
		return
	end
	if not player_data[player.name] then
		player_data[player.name] = {}
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:88')
	return player_data[player.name]
end

local get_gulag_permission_group = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:91')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:101')
	return gulag
end

local create_gulag_surface = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:104')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:171')
	return surface
end

local teleport_player_to_gulag = function(player, action)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:174')
	local p_data = get_player_data(player)

	local gulag_tp = function(surface)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:177')
...
local on_player_changed_surface = function(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:212')
	local player = game.players[event.player_index]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:215')
		return
	end

	if not jailed[player.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:219')
		return
	end
...
local validate_args = function(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:231')
	local player = data.player
	...
	if not griefer or not game.players[griefer] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:241')
		return false
	end
	...
	if votejail[player.name] and not player.admin then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:246')
		return false
	end

	if votefree[player.name] and not player.admin then
		Utils.print_to(player, "You are currently being investigated since you have griefed.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:251')
		return false
	end

	if jailed[player.name] and not player.admin then
		Utils.print_to(player, "You are jailed, you can´t run this command.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:256')
		return false
	end

	if player.name == griefer and not player.admin then
		Utils.print_to(player, "You can´t select yourself.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:261')
		return false
	end

	if game.players[griefer].admin and not player.admin then
		Utils.print_to(player, "You can´t select an admin.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:266')
		return false
	end
	...
	if not trusted and not player.admin or playtime <= settings.playtime_for_vote and not player.admin then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:271')
		return false
	end

	if not message then
		Utils.print_to(player, "No valid reason was given.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:276')
		return false
	end

	if cmd == "jail" and message and string.len(message) <= 0 then
		Utils.print_to(player, "No valid reason was given.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:281')
		return false
	end

	if cmd == "jail" and message and string.len(message) <= 10 then
		Utils.print_to(player, "Reason is too short.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:286')
		return false
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:289')
	return true
end

local vote_to_jail = function(player, griefer, msg)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:292')
...
local vote_to_free = function(player, griefer)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:316')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:341')
	return
end

local jail = function(player, griefer, msg)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:344')
	player = player or "script"
	if jailed[griefer] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:347')
		return false
	end

	if not msg then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:351')
		return
	end

	if not game.players[griefer] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:355')
		return
	end
	...
	if
		game.players[griefer].character
		and game.players[griefer].character.valid
		and game.players[griefer].character.driving
	then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:383')
	return true
end

local free = function(player, griefer)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:386')
	player = player or "script"
	if not jailed[griefer] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:389')
		return false
	end

	if not game.players[griefer] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:393')
		return
	end
	...
	Utils.print_to(nil, message)
	Utils.action_warning_embed("{Jailed}", message)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:414')
	return true
end
...
function Public.try_dl_data(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:441')
	key = tostring(key)

	local secs = Server.get_current_time()

	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:447')
		return
	else
...
function Public.try_ul_data(key, value, player, message)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:455')
...
function Public.exists(player_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:475')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:476')
	return jailed[player_name] ~= nil
end

--- Prints a list of all players in the player_jailed table.
function Public.print_jailed()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:480')
	local result = {}
...
function Public.get_jailed_table()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:493')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:494')
	return jailed
end
...
Event.add(defines.events.on_player_joined_game, function(event)
	...
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:500')
		return
	end
...
Event.add(defines.events.on_console_command, function(event)
	...
	if not valid_commands[cmd] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:509')
		return
	end
	...
	if event.player_index then
		...
		if not param then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:520')
		...
		if not success then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:547')
			return
		end
		...
		then
			if cmd == "jail" then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:562')
				return
			elseif cmd == "free" then
				vote_to_free(player, griefer)
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:565')
				return
			end
		end
		...
		if player.admin or playtime >= settings.playtime_for_instant_jail then
			if cmd == "jail" then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:578')
				return
			elseif cmd == "free" then
				Public.try_ul_data(griefer, false, player.name)
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:581')
				return
			end
		end
	end
...
commands.add_command("jail", "Sends the player to gulag! Valid arguments are:\n/jail <LuaPlayer> <reason>", function()
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:601')
	return
end)

commands.add_command("free", "Brings back the player from gulag.", function()
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:605')
	return
end)

function Public.required_playtime_for_instant_jail(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:608')
	if value then
		settings.playtime_for_instant_jail = value
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:612')
	return settings.playtime_for_instant_jail
end

function Public.required_playtime_for_vote(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:615')
	if value then
		settings.playtime_for_vote = value
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:619')
	return settings.playtime_for_vote
end

Event.on_init(get_gulag_permission_group)

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/jail_data.lua:624')
return Public

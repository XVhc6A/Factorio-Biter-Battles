...
local function is_game_modded()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:23')
	local i = 0
	for k, _ in pairs(game.active_mods) do
		i = i + 1
		if i > 1 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:28')
			return true
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:31')
	return false
end

local function apply_stash(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:34')
...
local fetch_quickbar = Token.register(function(data)
	...
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:51')
		return
	end
	if value then
...
local fetch_logistics = Token.register(function(data)
	...
	local player = game.players[key]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:67')
		return
	end
...
function Public.fetch_quickbar(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:88')
...
function Public.fetch_logistics(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:100')
...
function Public.save_quickbar(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:112')
	local dataset = quickbar_dataset
...
function Public.save_logistics(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:136')
	local dataset = logistics_dataset
...
function Public.remove_quickbar(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:160')
	local dataset = quickbar_dataset
...
function Public.remove_logistics(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:174')
	local dataset = logistics_dataset
...
commands.add_command("save-quickbar", "Save your personal quickbar preset so it´s always the same.", function()
	...
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:196')
		return
	end

	local secs = Server.get_current_time()
	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:201')
		return
	end
...
commands.add_command("save-logistics", "Save your personal logistics preset so it´s always the same.", function()
	local player = game.player
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:209')
		return
	end

	local secs = Server.get_current_time()
	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:214')
		return
	end
...
commands.add_command("remove-quickbar", "Removes your personal quickbar preset from the datastore.", function()
	local player = game.player
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:225')
		return
	end
	local secs = Server.get_current_time()
	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:229')
		return
	end
...
commands.add_command("remove-logistics", "Removes your personal logistics preset from the datastore.", function()
	local player = game.player
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:238')
		return
	end

	local secs = Server.get_current_time()
	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:243')
		return
	end
...
Event.add(defines.events.on_player_joined_game, function(event)
	...
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:252')
		return
	end

	local secs = Server.get_current_time()
	if not secs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:257')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/datastore/quickbar_data.lua:275')
return Public

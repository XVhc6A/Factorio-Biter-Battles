...
function table.remove_element(t, element)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:12')
...
function table.fast_remove(tbl, index)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:25')
	local count = #tbl
	if index > count then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:28')
		return
...
function table.add_all(t1, t2)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:39')
...
function table.index_of(t, e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:53')
	for k, v in pairs(t) do
		if v == e then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:56')
			return k
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:59')
	return nil
end
...
function table.index_of_in_array(t, e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:66')
	for i = 1, #t do
		if t[i] == e then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:69')
			return i
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:72')
	return nil
end
...
function table.contains(t, e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:80')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:81')
...
function table.array_contains(t, e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:89')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:90')
...
function table.set(t, index, element)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:97')
	local i = 1
	for k in pairs(t) do
		if i == index then
			t[k] = element
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:102')
			return nil
		end
		i = i + 1
	end
...
function table.keys(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:111')
	local n = 1
	local keys = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:120')
	return keys
end
...
function table.get_random_dictionary_entry(t, key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:128')
	local target_index = random(1, table_size(t))
	local count = 1
	for k, v in pairs(t) do
		if target_index == count then
			if key then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:134')
				return k
			else
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:136')
				return v
			end
		end
		count = count + 1
...
function table.get_random_weighted(weighted_table, item_index, weight_index)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:150')
	...
	for _, w in pairs(weighted_table) do
		...
		if weight_sum >= index then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:164')
			return w[item_index]
		end
	end
end
...
function table.get_random_weighted_chances(weighted_table, item_index, weight_index)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:173')
	local total_weight = 0
	item_index = item_index or 1
	weight_index = weight_index or 2
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:184')
	return chance_table
end
...
function table.shuffle_table(t, rng)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:191')
	local rand = rng or math.random
	local iterations = #t
	if iterations == 0 then
		error("Not a sequential table")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:196')
		return
	end
	local j
...
function table.clear_table(t, array)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:209')
	if array then
		for i = 1, #t do
			t[i] = nil
		end
...
function table.binary_search(t, target)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:237')
	...
	if upper == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:244')
		return -2 -- ~1
	end
	...
	repeat
		...
		if value == target then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:251')
			return mid
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:259')
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:270')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/table.lua:302')
return table

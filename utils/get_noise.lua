...
local function get_noise(name, pos, seed)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/get_noise.lua:143')
	local noise = 0
	local d = 0
	...
	noise = noise / d
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/get_noise.lua:153')
	return noise
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/get_noise.lua:156')
return get_noise

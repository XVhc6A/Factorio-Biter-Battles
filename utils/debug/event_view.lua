...
function Public.on_open_debug()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:33')
...
local function event_callback(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:52')
	local id = event.name
	if not enabled[id] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:55')
		return
	end
...
local function on_gui_checked_state_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:72')
...
local function redraw_event_table(gui_table, filter)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:95')
...
function Public.show(container)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:109')
...
Gui.on_text_changed(filter_name, function(event)
	local element = event.element
...
Gui.on_click(clear_filter_name, function(event)
	local element = event.element
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/event_view.lua:162')
return Public

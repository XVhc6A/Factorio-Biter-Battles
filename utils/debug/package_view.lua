...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/package_view.lua:4')
...
function Public.show(container)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/package_view.lua:34')
...
Gui.on_click(file_label_name, function(event)
...
Gui.on_click(variable_label_name, function(event)
	local element = event.element
	...
	if variable_type == "table" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/package_view.lua:135')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/package_view.lua:154')
return Public

...
function Public.show(container)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/_g_view.lua:62')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/_g_view.lua:110')
return Public

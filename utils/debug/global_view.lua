...
function Public.show(container)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/global_view.lua:20')
...
local function update_dump(text_input, data, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/global_view.lua:101')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/utils/debug/global_view.lua:127')
return Public

...
local function on_player_created(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/control.lua:109')
...
function require(path)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/control.lua:116')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/control.lua:117')

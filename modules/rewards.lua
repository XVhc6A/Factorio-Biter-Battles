...
local rewards_loot = {
	...
	[6] = {
		{ name = "land-mine", count = 30, text = " Landmines" },
		{ name = "raw-fish", count = 30, text = " Fish Food" },
	},
	[7] = {
...
local function create_reward_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:158')
...
local function show_rewards(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:170')
...
local function rewards_gui(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:239')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:241')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:244')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:247')
		return
	end
	...
	if name == "rewards" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:259')
		return
	end
end

-- Callback to trigger the player level
local callback = Token.register(function(data)
	if #data.pos_list < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:266')
		return
	end
...
local function reward_messages(data)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:275')
	local player = data.player
	local item_rewards = data.rewards
	-- Check that the table isn't empty
	if #item_rewards < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:280')
		return
	end
	local print_text = ""
	local text_effect = player.surface.create_entity({
		name = "flying-text",
...
local function kill_rewards(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:309')
	local get_score = Score.get_table().score_table
	if not event.cause then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:312')
		return
	end
	...
	if not kill_score then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:321')
		return
	end
...
local function check_data(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rewards.lua:380')

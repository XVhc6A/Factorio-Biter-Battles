...
local function get_rank()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:5')
	for i = #global.satellite_score, 1, -1 do
		if global.satellites_in_space >= global.satellite_score[i].goal then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:8')
			return i
		end
	end
end
...
local function satellite_score_toggle_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:13')
	if player.gui.top["satellite_score_toggle_button"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:15')
		return
	end
...
local function level_up_popup(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:29')
...
local function satellites_in_space_gui(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:44')
	...
	local progress = (global.satellites_in_space - global.satellite_score[i].goal)
	...
	local label = frame.add({
		type = "label",
		caption = global.satellites_in_space .. "/" .. tostring(global.satellite_score[i + 1].goal),
	})
...
local function on_rocket_launched(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:81')
	...
	if c == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:85')
		return
	end
	...
	if
		(global.satellites_in_space < 10)
		or ((global.satellites_in_space < 50) and ((global.satellites_in_space % 5) == 0))
		or ((global.satellites_in_space % 25) == 0)
	then
...
local function init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:113')
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:201')
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:213')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:215')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:218')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/satellite_score.lua:221')
		return
	end

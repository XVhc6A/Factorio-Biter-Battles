...
local function on_chunk_generated(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/ores_are_mixed.lua:12')
	local surface = event.surface
	local ores =
		surface.find_entities_filtered({ area = event.area, name = { "iron-ore", "copper-ore", "coal", "stone" } })
	if #ores == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/ores_are_mixed.lua:17')
		return
	end

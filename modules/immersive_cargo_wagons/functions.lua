...
function Public.request_reconstruction(icw)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:9')
	icw.rebuild_tick = game.tick + 30
end

local function delete_empty_surfaces(icw)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:13')
...
local function kick_players_out_of_vehicles(wagon)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:22')
...
local function connect_power_pole(entity, wagon_area_left_top_y)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:33')
	...
	for _, pole in pairs(surface.find_entities_filtered({ area = area, name = entity.name })) do
		if pole.position.y < wagon_area_left_top_y then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:43')
			return
		end
	end
end
...
local function equal_fluid(source_tank, target_tank)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:48')
	if not source_tank.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:50')
		return
	end
	if not target_tank.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:53')
		return
	end

	local source_fluid = source_tank.fluidbox[1]
	if not source_fluid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:58')
		return
	end
	...
	if amount <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:72')
		return
	end
...
local function divide_fluid(wagon, storage_tank)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:82')
...
local function input_filtered(wagon_inventory, chest, chest_inventory, free_slots)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:88')
	...
	for i = 1, wagon_inventory.get_bar() - 1, 1 do
		if free_slots <= 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:99')
			return
		end
...
local function input_cargo(wagon, chest)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:113')
	if not chest.request_from_buffers then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:115')
		return
	end
	...
	if not wagon_entity.valid then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:121')
		return
	end

	local wagon_inventory = wagon_entity.get_inventory(defines.inventory.cargo_wagon)
	if wagon_inventory.is_empty() then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:126')
		return
	end
	...
	if chest.get_request_slot(1) then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:139')
		return
	end

	for i = 1, wagon_inventory.get_bar() - 1, 1 do
		if free_slots <= 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:144')
			return
		end
...
local function output_cargo(wagon, passive_chest)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:154')
	...
	if passive_chest_inventory.is_empty() then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:157')
		return
	end
	...
	for i = 1, passive_chest_inventory.get_bar() - 1, 1 do
		if free_slots <= 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:168')
			return
		end
...
local function get_wagon_for_entity(icw, entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:184')
	local train = icw.trains[tonumber(entity.surface.name)]
	if not train then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:187')
		return
	end
	...
	for k, unit_number in pairs(train.wagons) do
		...
		if wagon then
			...
			then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:201')
				return wagon
			end
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:205')
	return false
end

local function kill_wagon_doors(icw, wagon)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:208')
...
local function construct_wagon_doors(icw, wagon)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:216')
...
local function get_player_data(icw, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:236')
	local player_data = icw.players[player.index]
	if icw.players[player.index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:239')
		return player_data
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:248')
	return icw.players[player.index]
end

function Public.kill_minimap(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:251')
...
function Public.kill_wagon(icw, entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:258')
	if not Constants.wagon_types[entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:260')
		return
	end
...
function Public.create_room_surface(icw, unit_number)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:287')
	if game.surfaces[tostring(unit_number)] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:289')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:313')
	return surface
end

function Public.create_wagon_room(icw, wagon)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:316')
	local surface = wagon.surface
	local area = wagon.area
	...
	if wagon.entity.type == "fluid-wagon" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:385')
		return
	end
	...
	if wagon.entity.type == "cargo-wagon" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:415')
		return
	end
end

function Public.create_wagon(icw, created_entity, delay_surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:419')
	if not created_entity.unit_number then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:421')
		return
	end
	if icw.trains[tonumber(created_entity.surface.name)] or icw.wagons[tonumber(created_entity.surface.name)] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:424')
		return
	end
	if not Constants.wagon_types[created_entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:427')
		return
	end
	...
	Public.request_reconstruction(icw)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:448')
	return wagon
end

function Public.add_wagon_entity_count(icw, added_entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:451')
	local wagon = get_wagon_for_entity(icw, added_entity)
	if not wagon then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:454')
		return
	end
...
function Public.subtract_wagon_entity_count(icw, removed_entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:460')
	local wagon = get_wagon_for_entity(icw, removed_entity)
	if not wagon then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:463')
		return
	end
	wagon.entity_count = wagon.entity_count - 1
	if wagon.entity_count > 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:467')
		return
	end
...
function Public.use_cargo_wagon_door(icw, player, door)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:472')
	...
	if player_data.state then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:479')
		return
	end

	if not door then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:483')
		return
	end
	if not door.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:486')
		return
	end
	...
	if not wagon then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:499')
		return
	end
	...
	if wagon.entity.surface.name ~= player.surface.name then
		...
		if not position then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:511')
			return
		end
...
local function move_room_to_train(icw, train, wagon)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:538')
	if not wagon then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:540')
		return
	end
	...
	if
		destination_area.left_top.x == wagon.area.left_top.x
		and destination_area.left_top.y == wagon.area.left_top.y
		and wagon.surface.name == train.surface.name
	then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:560')
		return
	end
	...
	for _, e in pairs(wagon.surface.find_entities_filtered({ name = "character", area = wagon.area })) do
		...
		if player then
			player_positions[player.index] =
				{ player.position.x, player.position.y + (destination_area.left_top.y - wagon.area.left_top.y) }
...
function Public.construct_train(icw, carriages)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:615')
	local unit_number = carriages[1].unit_number

	if icw.trains[unit_number] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:619')
		return
	end
...
function Public.reconstruct_all_trains(icw)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:630')
	icw.trains = {}
	for unit_number, wagon in pairs(icw.wagons) do
		if not wagon.entity or not wagon.entity.valid then
			icw.wagons[unit_number] = nil
			Public.request_reconstruction(icw)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:636')
			return
		end
...
function Public.item_transfer(icw)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:650')
...
function Public.draw_minimap(icw, player, surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:660')
	local element = player.gui.left.icw_map
	if not element then
		local player_data = get_player_data(icw, player)
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:675')
		return
	end
...
function Public.update_minimap(icw)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:680')
...
function Public.toggle_minimap(icw, event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:691')
	local element = event.element
	if not element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:694')
		return
	end
	if not element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:697')
		return
	end
	if element.name ~= "icw_map" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:700')
		return
	end
	...
	if event.button == defines.mouse_button_type.right then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:710')
		return
	end
	if event.button == defines.mouse_button_type.left then
		...
		element.zoom = player_data.zoom
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:718')
		return
	end
	if event.button == defines.mouse_button_type.middle then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:729')
		return
	end
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/immersive_cargo_wagons/functions.lua:733')
return Public

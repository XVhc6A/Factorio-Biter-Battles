...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:45')
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:46')
    return this
end

local function clear_gui(player)
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:49')
    local data = this.inf_gui[player.index]
    if not data then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:52')
        return
    end
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:64')
    mod(player).add(
        {
            type = 'sprite-button',
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:76')
    if not player then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:78')
        return false
    end
    if not player.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:81')
        return false
    end
    if not player.character then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:84')
        return false
    end
    if not player.connected then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:87')
        return false
    end
    if not game.players[player.index] then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:90')
        return false
    end
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:92')
    return true
end

local function item(item_name, item_count, player, storage)
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:95')
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:128')
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:160')
    chest_id = chest_id or this.player_chests[player.index].chest_id
    if not chest_id then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:163')
        return
    end
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:259')
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:338')
    local element = event.element
    local player = game.get_player(event.player_index)
    if not validate_player(player) then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:342')
        return
    end
    if not element.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:345')
        return
    end
    local parent = element.parent
    if not parent then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:349')
        return
    end
    if parent.name ~= 'personal_inventory' then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:352')
        return
    end
    local chest_id = this.player_chests[player.index].chest_id
    if not chest_id then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:356')
        return
    end
    ...
    if not storage then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:370')
        return
    end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:376')
        return
    end

    if this.editor[player.index] then
        if not storage[name] then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:381')
            return
        end
        if ctrl then
    ...
    if ctrl then
        ...
        if not count then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:408')
            return
        end
        local inserted = player.insert {name = name, count = count}
        if not inserted then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:412')
            return
        end
    ...
    elseif shift then
        ...
        if not count then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:426')
            return
        end
        if not stack then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:429')
            return
        end
        if count > stack then
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:446')
    local player = game.get_player(event.player_index)
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:455')
    local element = event.element
    local player = game.get_player(event.player_index)
    if not validate_player(player) then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:459')
        return
    end

    if not element.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:463')
        return
    end
    local parent = element.parent
    if not parent then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:467')
        return
    end
    if parent.name ~= 'personal_inventory' then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:470')
        return
    end

    local chest_id = this.player_chests[player.index].chest_id
    if not chest_id then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:475')
        return
    end
    local storage = this.inf_storage[chest_id]
    if not storage then
    ...
    if not name then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:485')
        return
    end
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:514')
    local player = game.get_player(event.player_index)
    if not (player and player.valid) then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:517')
        return
    end
...
local function tick()
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:545')
    update_chest()
    update_gui()
end

local function on_pre_player_left_game(event)
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:550')
    local player = game.get_player(event.player_index)

    if not player or not player.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:554')
        return
    end
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:560')
    local player = game.get_player(event.player_index)

    if not player or not player.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:564')
        return
    end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:575')
            return
        end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:597')
            return
        end

        local slider = data.slider
        if not slider or not slider.valid then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:602')
            return
        end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:624')
            return
        end
...
commands.add_command(
    ...
    function(cmd)
        ...
        if not validate_player(player) then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:643')
            return
        end

        if not cmd.parameter then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:647')
            return
        end
        local target_player = game.players[cmd.parameter]

        if target_player == player then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:652')
            return player.print('Cannot open self.', Color.warning)
        end

        if target_player.admin then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:656')
            return
        end
        ...
        if target_player and target_player.valid then
            ...
            if not chest_id then
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:662')
                return
            end
...
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:671')
    if value then
        this.ores_only = value
    else
        this.ores_only = false
    end
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:677')
    return this.ores_only
end

function Public.allow_barrels(value)
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:680')
    if value then
        this.allow_barrels = value
    else
        this.allow_barrels = false
    end
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:686')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/portable_chest.lua:697')
return Public

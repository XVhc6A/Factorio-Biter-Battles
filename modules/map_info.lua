...
Global.register(map_info, function(tbl)
	map_info = tbl
end)
...
function Public.Pop_info()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:18')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:19')
	return map_info
end

local create_map_intro = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:22')
	frame.clear()
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:87')
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:94')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:96')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:99')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:102')
		return
	end
	if event.element.name == "close_map_intro" then
		game.players[event.player_index].gui.left.comfy_panel.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:106')
		return
	end
end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/map_info.lua:116')
return Public

...
local function restrict_fluid_mining(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:13')
	if not max_fill_percentages[event.entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:15')
		return
	end
	if not event.entity.fluidbox then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:18')
		return
	end
	...
	if total_capacity == 0 or total_current_fluid_amount == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:35')
		return
	end
	...
	if fill_percentage < max_fill_percentages[event.entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:41')
		return
	end
	...
	for i = 1, #event.entity.fluidbox, 1 do
		if event.entity.fluidbox[i] then
			replacement_entity.fluidbox[i] = {
				name = event.entity.fluidbox[i].name,
				amount = event.entity.fluidbox[i].amount,
				temperature = event.entity.fluidbox[i].temperature,
			}
	...
	if not event.player_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:69')
		return
	end
...
local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:81')
	restrict_fluid_mining(event)
end

local function on_robot_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/restrictive_fluid_mining.lua:85')
	restrict_fluid_mining(event)
end

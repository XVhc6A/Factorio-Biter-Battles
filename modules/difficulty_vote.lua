...
function Public.set_tooltip(...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:74')
	if type(...) == "table" then
		this.tooltip = ...
	end
end
...
function Public.set_difficulties(...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:80')
	if type(...) == "table" then
		this.difficulties = ...
	end
end
...
function Public.set_poll_closing_timeout(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:86')
	this.difficulty_poll_closing_timeout = value or game.tick + 3600 * 20
end

function Public.get(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:90')
	if key then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:92')
		return this[key]
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:94')
		return this
	end
end

function Public.get_difficulty_vote_index()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:98')
	if this.difficulty_vote_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:100')
		return this.difficulty_vote_index
	end
end

function Public.difficulty_gui()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:104')
...
local function poll_difficulty(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:127')
	if player.gui.center["difficulty_poll"] then
		player.gui.center["difficulty_poll"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:130')
		return
	end
	if game.tick > this.difficulty_poll_closing_timeout then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:143')
		return
	end
...
local function set_difficulty()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:175')
	local a = 0
	local vote_count = 0
	...
	if vote_count == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:183')
		return
	end
	a = a / vote_count
...
function Public.reset_difficulty_poll(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:199')
	if tbl then
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:229')
...
local function on_player_left_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:243')
	if game.tick > this.difficulty_poll_closing_timeout then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:245')
		return
	end
	local player = game.players[event.player_index]
	if not this.difficulty_player_votes[player.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:249')
		return
	end
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:256')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:258')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:261')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:264')
		return
	end
	local player = game.players[event.element.player_index]
	if event.element.name == "difficulty_gui" then
		poll_difficulty(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:269')
		return
	end
	if event.element.type ~= "button" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:272')
		return
	end
	if event.element.parent.name ~= "difficulty_poll" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:275')
		return
	end
	if event.element.name == "close" then
		event.element.parent.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:279')
		return
	end
	if game.tick > this.difficulty_poll_closing_timeout then
		event.element.parent.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:283')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote.lua:300')
return Public

...
local function process_explosion_tile(pos, explosion_index, current_radius)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1653')
	...
	if tile.name == "out-of-map" then
		...
		global.explosion_schedule[explosion_index].damage_remaining = global.explosion_schedule[explosion_index].damage_remaining
	...
	if global.explosion_schedule[explosion_index].damage_remaining <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1715')
		return false
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1718')
	return true
end

local function create_explosion_schedule(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1721')
	...
	if explosives_amount < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1729')
		return
	end
	...
	for current_radius = 1, 23, 1 do
		...
		global.explosion_schedule[#global.explosion_schedule][current_radius].trigger_tick = game.tick
			+ (current_radius * 8)
...
local function on_entity_damaged(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1755')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1758')
		return
	end
	if not entity.health then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1761')
		return
	end
	if entity.health > entity.prototype.max_health * 0.75 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1764')
		return
	end
	...
	if entity.type == "container" or entity.type == "logistic-container" then
		if math.random(1, 3) == 1 or entity.health <= 0 then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1770')
			return
		end
	end
	if entity.type == "cargo-wagon" or entity.type == "car" then
		if entity.health <= 0 then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1776')
			return
		end
		if entity.health < 150 and math.random(1, 3) == 1 then
			create_explosion_schedule(entity)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1780')
			return
		end
	end
end
...
local function on_tick(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosives_are_explosive.lua:1785')

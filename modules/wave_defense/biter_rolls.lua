...
function Public.wave_defense_roll_biter_name()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:4')
	...
	for k, v in pairs(biter_raffle) do
		...
		if r <= current_chance then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:15')
			return k
		end
	end
end
...
function Public.wave_defense_roll_spitter_name()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:20')
	...
	for k, v in pairs(spitter_raffle) do
		current_chance = current_chance + v
		if r <= current_chance then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:31')
			return k
		end
	end
end
...
function Public.wave_defense_set_unit_raffle(level)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:36')
	WD.set("biter_raffle", {
...
function Public.wave_defense_roll_worm_name()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:74')
	...
	for k, v in pairs(worm_raffle) do
		current_chance = current_chance + v
		if r <= current_chance then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:85')
			return k
		end
	end
end
...
function Public.wave_defense_set_worm_raffle(level)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:90')
	WD.set("worm_raffle", {
...
function Public.wave_defense_print_chances(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:113')
	for k, v in pairs(tbl) do
		game.print(k .. " chance = " .. v)
	end
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/wave_defense/biter_rolls.lua:119')
return Public

...
local function init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/scramble_ores.lua:8')
	global.diverse_ores = {}
...
local function scramble(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/scramble_ores.lua:21')

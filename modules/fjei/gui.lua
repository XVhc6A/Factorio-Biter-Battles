...
local function save_window_location(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:16')
	if not global.fjei.player_data then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:18')
		return
	end
	if not global.fjei.player_data[player.index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:21')
		return
	end
...
local function get_total_page_count(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:26')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:34')
	return count
end

local function set_page_count_caption(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:37')
	if not global.fjei.player_data[player.index].filtered_list then
		Functions.set_filtered_list(player)
	end
	...
	--set textfield width
	local style =
		player.gui.left.fjei_main_window.fjei_main_window_control_table.fjei_main_window_search_textfield.style
...
local function get_formatted_amount(amount)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:54')
	if amount < 1000 then
		amount = amount .. " x "
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:57')
		return amount
	end
	if amount >= 1000000 then
		amount = math.floor(amount * 0.00001) * 0.1 .. "m "
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:61')
		return amount
	end
	if amount >= 1000 then
		amount = math.floor(amount * 0.01) * 0.1 .. "k "
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:65')
		return amount
	end
end

local function get_localised_name(name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:69')
	local item = game.item_prototypes[name]
	if item then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:72')
		return item.localised_name
	end
	local fluid = game.fluid_prototypes[name]
	if fluid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:76')
		return fluid.localised_name
	end
	local recipe = game.recipe_prototypes[name]
	if recipe then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:80')
		return recipe.localised_name
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:82')
	return name
end

local function get_sprite_type(name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:85')
	if game.item_prototypes[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:87')
		return "item"
	end
	if game.fluid_prototypes[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:90')
		return "fluid"
	end
	if game.entity_prototypes[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:93')
		return "entity"
	end
	if game.recipe_prototypes[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:96')
		return "recipe"
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:98')
	return false
end

local function get_active_recipe_name(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:101')
	local fjei_recipe_window = player.gui[recipe_window_position]["fjei_recipe_window"]
	if not fjei_recipe_window then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:104')
		return
	end
	if not fjei_recipe_window.recipe_container then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:107')
		return
	end
	local container = fjei_recipe_window.recipe_container.children[1]
	if not container then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:111')
		return
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:113')
	return container.children[1].name
end

local function add_choose_elem_button(element, name, is_recipe)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:116')
	local elem_type
	if is_recipe then
		elem_type = "recipe"
	else
	...
	if not elem_type then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:124')
		return
	end
...
local function add_sprite_icon(element, name, is_recipe, use_localised_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:141')
	...
	if not sprite_type then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:150')
		return
	end
	...
	if use_localised_name then
		sprite = element.add({
			type = "sprite",
			name = name,
			sprite = sprite_type .. "/" .. name,
			tooltip = get_localised_name(name),
		})
	else
...
local function display_item_list(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:173')
	if not player.gui.left.fjei_main_window then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:175')
		return
	end
	if not global.fjei.player_data[player.index].filtered_list then
		Functions.set_filtered_list(player)
	...
	for i = starting_index, starting_index + items_per_page - 1, 1 do
		if not filtered_list[i] then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:190')
			return
		end
...
local function display_history(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:196')
	if not player.gui.left.fjei_main_window then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:198')
		return
	end
	local player_data = global.fjei.player_data[player.index]
	local history = player_data.history
	if not history then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:203')
		return
	end
...
function Public.refresh_main_window(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:216')
	if not player.gui.left.fjei_main_window then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:218')
		return
	end
...
local function draw_main_window(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:225')
...
local function refresh_recipe_bar(player, selected_recipe)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:267')
	local old_recipe_name = get_active_recipe_name(player)
	if not old_recipe_name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:270')
		return
	end

	if not player.gui[recipe_window_position]["fjei_recipe_window"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:274')
		return
	end
	if not player.gui[recipe_window_position]["fjei_recipe_window"].header_container then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:277')
		return
	end
...
local function draw_recipe_window_header(player, container, item_name, recipes, mode, recipe_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:294')
	if mode == 1 then
		container.parent.caption = "Product of recipe: "
	else
		container.parent.caption = "Ingredient in recipe: "
	end
...
local function draw_recipe(player, container, recipe_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:339')
	...
	local element =
		tt.add({ type = "label", caption = "◷ " .. math.round(recipe.energy, 2) .. " seconds crafting time" })
	...
	if #machines == 0 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:451')
		return
	end
...
local function create_recipe_window(item_name, player, button, selected_recipe)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:467')
	local mode
	...
	if selected_recipe and player.gui[recipe_window_position]["fjei_recipe_window"] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:480')
		return
	end

	if not global.fjei.item_list[item_name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:484')
		return
	end
	...
	if size_of_recipes == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:521')
		return
	end
	...
	if not selected_recipe then
		for key, recipe_name in pairs(recipes) do
			if
				#Functions.get_crafting_machines_for_recipe(player.force.name, game.recipe_prototypes[recipe_name]) > 0
			then
	...
	local frame = player.gui[recipe_window_position].add({
		type = "frame",
		name = "fjei_recipe_window",
		direction = "vertical",
		caption = " ",
	})
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:578')
	return true
end

local function add_to_history(item_name, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:581')
	if not game.item_prototypes[item_name] and not game.fluid_prototypes[item_name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:583')
		return
	end
	...
	if not player_data.history then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:590')
		return
	end
	...
	for k, v in pairs(player_data.history) do
		if v == item_name then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:598')
			return
		end
	end
	...
	if player_data.size_of_history >= column_count then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:606')
		return
	end
...
local function show_cursor_stack_item(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:613')
	local cursor_stack = player.cursor_stack
	if not cursor_stack then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:616')
		return
	end
	if not cursor_stack.valid_for_read then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:619')
		return
	end
	...
	if not global.fjei.item_list[cursor_stack.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:628')
		return
	end
	add_to_history(cursor_stack.name, player)
	draw_main_window(player)
	create_recipe_window(cursor_stack.name, player, button)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:633')
	return true
end

local function toggle_main_window(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:636')
	if show_cursor_stack_item(element, player, button) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:638')
		return true
	end
	if player.gui.left.fjei_main_window then
		player.gui.left.fjei_main_window.destroy()
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:648')
	return true
end

local function main_window_next_page(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:651')
	local player_data = global.fjei.player_data[player.index]
	...
	Public.refresh_main_window(player)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:669')
	return true
end

local function main_window_previous_page(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:672')
	local player_data = global.fjei.player_data[player.index]
	if button == defines.mouse_button_type.right then
		for _ = 1, 5, 1 do
	...
	Public.refresh_main_window(player)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:690')
	return true
end

local function clear_search_textfield(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:693')
	if show_cursor_stack_item(element, player, button) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:695')
		return true
	end
	if button ~= defines.mouse_button_type.right then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:698')
		return
	end
	...
	Functions.set_filtered_list(player)
	Public.refresh_main_window(player)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:704')
	return true
end

local function close_recipe_window(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:707')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:713')
	return true
end
...
function Public.gui_click_actions(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:724')
	if not gui_actions[element.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:726')
		return
	end
	if not global.fjei then
		Functions.build_tables()
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:735')
	return true
end

function Public.draw_top_toggle_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:738')
	if player.gui.top["fjei_toggle_button"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:740')
		return
	end
...
function Public.open_recipe(element, player, button)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:750')
	if not global.fjei then
		Functions.build_tables()
	end
	if not global.fjei.player_data[player.index] then
	...
	if element.parent.name == "fjei_recipe_window_selected_recipe" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:762')
		return
	end
	...
	if
		element.parent.name == "fjei_main_window_item_list_table"
		or element.parent.name == "fjei_main_window_history_table"
	then
		local recipe_window = player.gui[recipe_window_position]["fjei_recipe_window"]
		if recipe_window then
			...
			if active_item == element.name and global.fjei.player_data[player.index].last_button == button then
				save_window_location(player, recipe_window)
				recipe_window.destroy()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:781')
				return
			end
		end
	end
	...
	if not create_recipe_window(item_name, player, button, selected_recipe) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:788')
		return
	end
	display_history(player)
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/gui.lua:795')
return Public

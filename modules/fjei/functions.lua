...
function Public.get_crafting_machines_for_recipe(force_name, recipe)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:5')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:23')
	return result
end

local function set_crafting_machines()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:26')
...
local function is_uncommon_recipe(recipe_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:39')
	for _, name in pairs(uncommon_recipes) do
		local a, b = string_find(recipe_name, name, 1, true)
		if a then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:43')
			return true
		end
	end
end
...
local function shift_uncommon_recipe_names(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:48')
	local list_common = {}
	local list_uncommon = {}
	...
	if #list_uncommon == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:60')
		return
	end
...
local function add_item_list_product(item_list, product_name, recipe_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:74')
...
local function add_item_list_ingredient(item_list, ingredient_name, recipe_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:81')
...
local function set_item_list()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:88')
		...
		if v[1] then
			if v[1][2] then
				table.sort(v[1], function(a, b)
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:104')
					return a < b
				end)
		...
		if v[2] then
			if v[2][2] then
				table.sort(v[2], function(a, b)
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:112')
					return a < b
				end)
...
local function set_sorted_item_list()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:120')
	...
	table.sort(sorted_items, function(a, b)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:136')
		return a < b
	end)
	...
	table.sort(sorted_fluids, function(a, b)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:148')
		return a < b
	end)
...
local function add_recipe_to_whitelist(item_whitelist, recipe)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:162')
	for key, product in pairs(recipe.products) do
...
function Public.add_research_to_whitelist(force, effects)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:171')
	if not effects then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:173')
		return
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:183')
	return items_have_been_added
end

local function set_item_whitelist(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:186')
...
local function set_item_whitelists_for_all_forces()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:203')
...
function Public.set_filtered_list(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:212')
...
function Public.build_tables()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:239')
	global.fjei = {}
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/fjei/functions.lua:248')
return Public

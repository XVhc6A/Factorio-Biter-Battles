...
local function on_chunk_generated(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/surrounded_by_worms.lua:20')
	...
	if global.worm_distance > chunk_distance_to_center then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/surrounded_by_worms.lua:29')
		return
	end

...
local function drop_inventory(player, inventory)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/ban_drop.lua:2')
	if not inventory then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/ban_drop.lua:4')
		return
	end
	if not inventory.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/ban_drop.lua:7')
		return
	end
	if inventory.is_empty() then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/ban_drop.lua:10')
		return
	end
...
local function on_player_banned(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/ban_drop.lua:22')

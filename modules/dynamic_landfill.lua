...
local function get_chunk_position(position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:31')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:45')
	return chunk_position
end

local function regenerate_decoratives(surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:48')
	local chunk = get_chunk_position(position)
	if not chunk then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:51')
		return
	end
...
local function is_this_a_valid_source_tile(pos, tiles)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:63')
	for _, tile in pairs(tiles) do
		if tile.position.x == pos.x and tile.position.y == pos.y then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:66')
			return false
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:69')
	return true
end

local function place_fitting_tile(position, surface, tiles_placed)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:72')
	for _, coord in pairs(spiral_coords) do
		...
		if not tile.collides_with("player-layer") then
			...
			if valid_source_tile then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:87')
				return
			end
		end
	end
...
local function on_player_built_tile(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:93')
	if not event.item then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:95')
		return
	end
	if event.item.name ~= "landfill" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:98')
		return
	end
...
local function on_robot_built_tile(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:114')
	if event.item.name ~= "landfill" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dynamic_landfill.lua:116')
		return
	end

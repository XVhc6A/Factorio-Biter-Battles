...
local function damage_entities_in_radius(surface, position, radius)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosive_player_respawn.lua:3')
...
local function on_player_respawned(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosive_player_respawn.lua:15')

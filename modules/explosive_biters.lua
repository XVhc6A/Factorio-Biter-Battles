...
local function damage_entities_in_radius(surface, position, radius, damage)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosive_biters.lua:10')
	local entities_to_damage = surface.find_entities_filtered({
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosive_biters.lua:30')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/explosive_biters.lua:32')
		return
	end

...
local function get_chances()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:26')
	local chances = {}
	...
	if game.entity_prototypes["angels-ore1"] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:34')
		return chances
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:42')
	return chances
end

local function set_raffle()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:45')
...
local function create_particles(surface, name, position, amount, cause_position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:55')
...
local function get_amount(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:82')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:97')
	return amount
end

local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:100')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:103')
		return
	end
	if not rock_yield[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:106')
		return
	end
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:160')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:163')
		return
	end
	if not rock_yield[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:166')
		return
	end
	...
	if event.cause then
		if event.cause.valid then
			if event.cause.force.index == 2 or event.cause.force.index == 3 then
				entity.destroy()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:178')
				return
			end
		end
	end
...
local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore.lua:196')

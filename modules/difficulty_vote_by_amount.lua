...
function Public.difficulty_gui()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:76')
...
local function highest_count(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:100')
	local init = {
		count = {},
		index = {},
	}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:137')
	return highest
end

local function poll_difficulty(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:140')
	if player.gui.center["difficulty_poll"] then
		player.gui.center["difficulty_poll"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:143')
		return
	end
	if game.tick > this.difficulty_poll_closing_timeout then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:156')
		return
	end
	...
	local b = frame.add({
		...
		name = "close",
		caption = "Close ("
			.. math.floor((this.difficulty_poll_closing_timeout - game.tick) / 3600)
			.. " minutes left)",
	})
...
local function set_difficulty()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:185')
...
function Public.reset_difficulty_poll(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:200')
	if tbl then
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:234')
...
local function on_player_left_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:248')
	if game.tick > this.difficulty_poll_closing_timeout then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:250')
		return
	end
	local player = game.players[event.player_index]
	if not this.difficulty_player_votes[player.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:254')
		return
	end
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:266')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:268')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:271')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:274')
		return
	end
	local player = game.players[event.element.player_index]
	if event.element.name == "difficulty_gui" then
		poll_difficulty(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:279')
		return
	end
	if event.element.type ~= "button" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:282')
		return
	end
	if event.element.parent.name ~= "difficulty_poll" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:285')
		return
	end
	if event.element.name == "close" then
		event.element.parent.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:289')
		return
	end
	if game.tick > this.difficulty_poll_closing_timeout then
		event.element.parent.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:293')
		return
	end
	...
	if this.difficulty_player_votes[player.name] and this.difficulty_player_votes[player.name].index == i then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:303')
...
function Public.set_tooltip(...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:326')
	if type(...) == "table" then
		this.tooltip = ...
	end
end
...
function Public.set_difficulties(...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:332')
	if type(...) == "table" then
		this.difficulties = ...
	end
end
...
function Public.set_poll_closing_timeout(...)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:338')
	this.difficulty_poll_closing_timeout = ...
end

function Public.get_fair_vote()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:342')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:343')
	return this.fair_vote
end

function Public.set_fair_vote(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:346')
	this.fair_vote = value or false
end

function Public.get(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:350')
	if key then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:352')
		return this[key]
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:354')
		return this
	end
end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/difficulty_vote_by_amount.lua:362')
return Public

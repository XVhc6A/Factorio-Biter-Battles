...
local function update_player_modifiers(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:12')
	if global.hydration[player.index] <= 0 then
		global.hydration[player.index] = 100
		player.character.die()
		game.print(player.name .. " forgot to take a sip.")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:17')
		return
	end
...
local function update_hydration_meter(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:28')
	...
	if not hydration_meter then
		...
		label.style.font_color = { 175, 175, 175 }
		label.tooltip = tooltip
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:50')
		return
	end
...
local function sip(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:56')
	if not global.hydration[player.index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:58')
		return
	end
	...
	if global.hydration[player.index] == 100 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:64')
		return
	end
	...
	if
		player.surface.count_tiles_filtered({
			...
			area = {
				{ player.position.x - 1, player.position.y - 1 },
				{ player.position.x + 1, player.position.y + 1 },
			},
		}) > 0
	then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:80')
		return
	end

	if global.hydration[player.index] > 90 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:84')
		return
	end
	...
	if removed_count == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:90')
		return
	end
	...
	if inserted_count > 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:98')
		return
	end
...
local function on_player_changed_position(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:104')
	if math_random(1, 320) ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:106')
		return
	end
	local player = game.players[event.player_index]
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:110')
		return
	end
	if not player.character.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:113')
		return
	end
	if player.vehicle then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:116')
		return
	end
	global.hydration[player.index] = global.hydration[player.index] - 1
end
...
local function on_player_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:121')
	if not global.hydration[event.player_index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:123')
		return
	end
...
local function tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:128')
...
local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/thirst.lua:140')
	global.hydration = {}
end

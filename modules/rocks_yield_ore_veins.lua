...
local function get_chances()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:17')
	local chances = {}
	...
	if game.entity_prototypes["angels-ore1"] then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:26')
		return chances
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:36')
	return chances
end

local function set_raffle()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:39')
	...
	if game.entity_prototypes["angels-ore1"] then
		global.rocks_yield_ore_veins.mixed_ores =
			{ "angels-ore1", "angels-ore2", "angels-ore3", "angels-ore4", "angels-ore5", "angels-ore6", "coal" }
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:50')
		return
	end
...
local function get_amount(position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:56')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:60')
	return distance_to_center * m
end

local function draw_chain(surface, count, ore, ore_entities, ore_positions)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:63')
		...
		for i = 1, 4, 1 do
			...
			if surface.can_place_entity({ name = "coal", position = p, amount = 1 }) then
				if not ore_positions[p.x .. "_" .. p.y] then
					...
					local name = ore
					if ore == "mixed" then
						name = global.rocks_yield_ore_veins.mixed_ores[math_random(
							1,
							#global.rocks_yield_ore_veins.mixed_ores
						)]
					end
...
local function ore_vein(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:91')
...
local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:173')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:175')
		return
	end
	if not valid_entities[event.entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:178')
		return
	end
	if math_random(1, global.rocks_yield_ore_veins.chance) ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:181')
		return
	end
	ore_vein(event)
end
...
local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rocks_yield_ore_veins.lua:186')

...
local function get_coin_count(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:31')
	local coin_count = coin_yield[entity.name]
	if not coin_count then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:34')
		return
	end
	if not global.biter_health_boost_units then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:37')
		return coin_count
	end
	local unit_number = entity.unit_number
	if not unit_number then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:41')
		return coin_count
	end
	if not global.biter_health_boost_units[unit_number] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:44')
		return coin_count
	end
	if not global.biter_health_boost_units[unit_number][3] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:47')
		return coin_count
	end
	local m = 1 / global.biter_health_boost_units[unit_number][2]
	coin_count = math_floor(coin_count * m)
	if coin_count < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:52')
		return 1
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:54')
	return coin_count
end

local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:57')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:60')
		return
	end
	if entity.force.index ~= 2 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:63')
		return
	end

	local coin_count = get_coin_count(entity)
	if not coin_count then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/biters_yield_coins.lua:68')
		return
	end

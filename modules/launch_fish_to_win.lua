...
local function goals()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:4')
...
local function get_rank()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:92')
	if not global.catplanet_goals then
		goals()
	end
	for i = #global.catplanet_goals, 1, -1 do
		if global.fish_in_space >= global.catplanet_goals[i].goal then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:98')
			return i
		end
	end
end
...
local function fish_in_space_toggle_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:103')
	if player.gui.top["fish_in_space_toggle"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:105')
		return
	end
...
local function level_up_popup(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:122')
...
local function fish_in_space_gui(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:137')
	if global.fish_in_space == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:139')
		return
	end
	local i = get_rank()
	...
	local label = frame.add({
		type = "label",
		caption = global.fish_in_space .. "/" .. tostring(global.catplanet_goals[i + 1].goal),
	})
...
local function fireworks(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:177')
...
local function on_rocket_launched(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:196')
	...
	if launched_fish_count == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:200')
		return
	end
...
local function init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:220')
	global.fish_in_space = 0
end

local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:224')
...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:232')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:234')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:237')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:240')
		return
	end
...
local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:259')
...
local function tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:265')
	if not global.fish_autolaunch then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/launch_fish_to_win.lua:267')
		return
	end

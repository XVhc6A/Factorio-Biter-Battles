...
local function count_nearby_ore(surface, position, ore_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:126')
	local count = 0
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:138')
	return count
end

local function draw_town_spawn(player_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:141')
...
local function is_valid_location(surface, entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:253')
	for _, vector in pairs(market_collide_vectors) do
		...
		if not surface.can_place_entity({ name = "iron-chest", position = p }) then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:263')
			return
		end
	end
	...
	if global.towny.size_of_town_centers > 48 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:274')
		return
	end
	...
	if entity.position.x ^ 2 + entity.position.y ^ 2 < square_min_distance_to_spawn then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:284')
		return
	end
	...
	if surface.count_entities_filtered({ area = area, name = "market" }) > 0 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:298')
		return
	end
	...
	if count > 2 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:319')
		return
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:322')
	return true
end

function Public.set_market_health(entity, final_damage_amount)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:325')
...
local function is_color_used(color, town_centers)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:336')
	for k, center in pairs(town_centers) do
		if center.color then
			if center.color.r == color.r and center.color.g == color.g and center.color.b == color.b then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:340')
				return true
			end
		end
	end
...
local function get_color()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:346')
	...
	for i = 1, #colors, 1 do
		...
		if not is_color_used(c, town_centers) then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:359')
			return c
		end
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:363')
	return c
end

function Public.found(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:366')
	local entity = event.created_entity
	if entity.force.index ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:369')
		return
	end
	if entity.name ~= "stone-furnace" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:372')
		return
	end
	...
	if game.forces[player_name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:379')
		return
	end

	local inventory = player.get_main_inventory()
	if inventory.get_item_count("small-plane") < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:384')
		return
	end
	...
	if global.towny.cooldowns[player.index] then
		if game.tick < global.towny.cooldowns[player.index] then
			surface.create_entity({
				name = "flying-text",
				position = entity.position,
				text = "Town founding is on cooldown for " .. math.ceil(
					(global.towny.cooldowns[player.index] - game.tick) / 3600
				) .. " minutes.",
				color = { r = 0.77, g = 0.0, b = 0.0 },
			})
			player.insert({ name = "stone-furnace", count = 1 })
			entity.destroy()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:401')
			return true
		end
	end
	...
	if not is_valid_location(surface, entity) then
		player.insert({ name = "stone-furnace", count = 1 })
		entity.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:408')
		return true
	end
	...
	town_center.chunk_position =
		{ math.floor(town_center.market.position.x / 32), math.floor(town_center.market.position.y / 32) }
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:468')
	return true
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/town_center.lua:471')
return Public

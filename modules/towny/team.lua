...
local function can_force_accept_member(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:6')
	...
	if size_of_town_centers <= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:12')
		return true
	end
	...
	if #force.connected_players >= member_limit then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:25')
		return
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:27')
	return true
end

function Public.set_player_color(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:30')
	if player.force.index == 1 then
		player.color = outlander_color
		player.chat_color = outlander_chat_color
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:34')
		return
	end
	local town_center = global.towny.town_centers[player.force.name]
	if not town_center then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:38')
		return
	end
...
function Public.set_town_color(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:44')
	if event.command ~= "color" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:46')
		return
	end
	...
	if player.force.index == 1 then
		player.color = outlander_color
		player.chat_color = outlander_chat_color
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:52')
		return
	end
	local town_center = global.towny.town_centers[player.name]
	if not town_center then
		Public.set_player_color(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:57')
		return
	end
...
function Public.set_all_player_colors()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:67')
...
function Public.add_player_to_town(player, town_center)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:73')
...
function Public.give_outlander_items(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:80')
...
function Public.set_player_to_outlander(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:87')
...
local function ally_outlander(player, target)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:94')
	...
	if requesting_force.index ~= 1 and target_force.index ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:99')
		return
	end
	if requesting_force.index == 1 and target_force.index == 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:102')
		return true
	end
	...
	if requesting_force.index == 1 then
				...
				if global.towny.requests[target_player.index] == player.name then
					if global.towny.town_centers[target_force.name] then
						if not can_force_accept_member(target_force) then
							log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:120')
							return true
						end
						game.print(
						...
						log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:127')
						return true
					end
				end
			end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:134')
		return true
	end

	if target_force.index == 1 then
		if target.type ~= "character" then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:139')
			return true
		end
		local target_player = target.player
		if not target_player then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:143')
			return true
		end
		...
		if global.towny.requests[target_player.index] then
			if global.towny.requests[target_player.index] == player.force.name then
				if not can_force_accept_member(player.force) then
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:150')
					return true
				end
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:170')
				return true
			end
		end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:191')
		return true
	end
end

local function ally_neighbour_towns(player, target)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:195')
	local requesting_force = player.force
	local target_force = target.force

	if target_force.get_friend(requesting_force) and requesting_force.get_friend(target_force) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:200')
		return
	end
...
function Public.ally_town(player, item)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:217')
	...
	if not target then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:235')
		return
	end
	if target.force.index == 2 or target.force.index == 3 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:238')
		return
	end

	if ally_outlander(player, target) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:242')
		return
	end
...
function Public.declare_war(player, item)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:247')
	local position = item.position
	local surface = player.surface
	local area = {
		{ position.x - item_drop_radius, position.y - item_drop_radius },
	...
	if not target then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:259')
		return
	end
	local target_force = target.force
	if target_force.index <= 3 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:263')
		return
	end
	...
	if requesting_force.name == target_force.name then
		...
		if player.name == target.force.name then
			if target.type ~= "character" then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:274')
				return
			end
			local target_player = target.player
			if not target_player then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:278')
				return
			end
			if target_player.index == player.index then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:281')
				return
			end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:290')
		return
	end

	if requesting_force.index == 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:294')
		return
	end
...
function Public.reveal_entity_to_all(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:313')
	local chart_area = {
...
local function delete_chart_tag_for_all_forces(market)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:324')
	local forces = game.forces
	local position = market.position
	local surface = market.surface
	for _, force in pairs(forces) do
		local tags = force.find_chart_tags(
			surface,
...
function Public.add_chart_tag(force, market)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:342')
	local position = market.position
	local tags = force.find_chart_tags(
		market.surface,
		{ { position.x - 0.1, position.y - 0.1 }, { position.x + 0.1, position.y + 0.1 } }
	...
	if tags[1] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:349')
		return
	end
	force.add_chart_tag(
		market.surface,
...
function Public.update_town_chart_tags()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:357')
	local town_centers = global.towny.town_centers
	local forces = game.forces
...
function Public.add_new_force(force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:370')
...
function Public.kill_force(force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:383')
	...
	game.print(
		">> "
			...
			.. math.floor(market.position.x)
			.. ","
			.. math.floor(market.position.y)
			.. "]",
		{ 255, 255, 0 }
	)
end
...
function Public.setup_player_force()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:449')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/team.lua:475')
return Public

...
local function get_commmands(target, group)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:8')
	local commands = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:48')
	return commands
end

local function roll_market()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:51')
	local r_max = 0
	...
	if r_max == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:64')
		return
	end
	...
	for k, town_center in pairs(town_centers) do
		if town_center.research_counter >= research_threshold then
			...
			if r <= chance then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:73')
				return town_center
			end
		end
	end
...
local function get_random_close_spawner(surface, market)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:79')
	local spawners = surface.find_entities_filtered({ type = "unit-spawner" })
	if not spawners[1] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:82')
		return false
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:96')
	return spawner
end

local function is_swarm_valid(swarm)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:99')
	local group = swarm.group
	if not group then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:102')
		return
	end
	if not group.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:105')
		return
	end
	if game.tick >= swarm.timeout then
		group.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:109')
		return
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:111')
	return true
end

function Public.validate_swarms()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:114')
...
function Public.wipe_units_out_of_evo_range()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:123')
	local units_to_wipe = {}
	local evo = game.forces.enemy.evolution_factor
	if evo > 0.80 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:127')
		return
	end
...
function Public.clear_spawn_for_player(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:146')
	local area =
		{ { player.position.x - 64, player.position.y - 64 }, { player.position.x + 64, player.position.y + 64 } }
	for _, e in
		pairs(player.surface.find_entities_filtered({
			force = "enemy",
...
function Public.unit_groups_start_moving()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:160')
	for k, swarm in pairs(global.towny.swarms) do
		if swarm.group then
...
function Public.swarm()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:170')
	local count = 0
	for k, swarm in pairs(global.towny.swarms) do
		count = count + 1
	end
	if count > 6 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:176')
		return
	end

	local town_center = roll_market()
	if not town_center then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:181')
		return
	end
	...
	if not spawner then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:187')
		return
	end
	local units = spawner.surface.find_enemy_units(spawner.position, 160, market.force)
	if not units[1] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:191')
		return
	end
	...
	if not unit_group_position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:195')
		return
	end
...
function Public.set_evolution()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:213')
	local town_center_count = global.towny.size_of_town_centers
	if town_center_count == 0 then
		game.forces.enemy.evolution_factor = 0
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:217')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/biters.lua:235')
return Public

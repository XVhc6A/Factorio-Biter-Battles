...
local upgrade_functions = {
	...
	[1] = function(town_center)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:5')
		if town_center.max_health > 500000 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:7')
			return
		end
	...
	[2] = function(town_center)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:14')
		local force = town_center.market.force
		if force.character_inventory_slots_bonus > 100 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:17')
			return
		end
	...
	[3] = function(town_center)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:22')
		local force = town_center.market.force
		if town_center.upgrades.mining_prod >= 10 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:25')
			return
		end
...
local function clear_offers(market)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:32')
	for i = 1, 256, 1 do
		local a = market.remove_market_item(1)
		if a == false then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:36')
			return
		end
	end
end
...
local function set_offers(town_center)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:41')
	...
	if force.character_inventory_slots_bonus <= 100 then
		special_offers[2] =
			{ { { "coin", (force.character_inventory_slots_bonus / 5 + 1) * 50 } }, "Upgrade Backpack +5 Slot" }
	else
		special_offers[2] = { { { "computer", 1 } }, "Maximum Backpack upgrades reached!" }
	end
	if town_center.upgrades.mining_prod < 10 then
		special_offers[3] =
			{ { { "coin", (town_center.upgrades.mining_prod + 1) * 400 } }, "Upgrade Mining Productivity +10%" }
	else
	...
	table.insert(
		market_items,
		{ price = { { "coin", 1 } }, offer = { type = "give-item", item = "raw-fish", count = 1 } }
	)
...
function Public.refresh_offers(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:116')
	local market = event.entity or event.market
	if not market then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:119')
		return
	end
	if not market.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:122')
		return
	end
	if market.name ~= "market" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:125')
		return
	end
	local town_center = global.towny.town_centers[market.force.name]
	if not town_center then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:129')
		return
	end
	clear_offers(market)
...
function Public.offer_purchased(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:135')
	local offer_index = event.offer_index
	if not upgrade_functions[offer_index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:138')
		return
	end
	...
	local town_center = global.towny.town_centers[market.force.name]
	if not town_center then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:145')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/towny/market.lua:158')
return Public

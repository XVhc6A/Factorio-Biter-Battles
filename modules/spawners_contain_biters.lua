...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/spawners_contain_biters.lua:18')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/spawners_contain_biters.lua:20')
		return
	end
	if event.entity.type ~= "unit-spawner" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/spawners_contain_biters.lua:23')
		return
	end

...
local function shuffle(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:10')
	local size = #tbl
	for i = size, 1, -1 do
		local rand = math_random(size)
		tbl[i], tbl[rand] = tbl[rand], tbl[i]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:16')
	return tbl
end
...
local function create_particles(surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:21')
...
local function on_player_rotated_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:37')
	if not global.level_unlocks then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:39')
		return
	end
	...
	if not global.level_unlocks[position_string] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:46')
		return
	end
	if global.level_unlocks[position_string].unlocked then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:49')
		return
	end
	...
	game.print(
		game.players[event.player_index].name .. " unlocked the path to Chapter " .. tostring(level_unlocked) .. "!"
	)
...
local function on_tick(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:85')
	if not global.area_tiles_unlock_schedule then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/area_unlocked_on_rotated_entity.lua:87')
		return
	end

	global.area_tiles_unlock_schedule[#global.area_tiles_unlock_schedule].surface.set_tiles(
		{ global.area_tiles_unlock_schedule[#global.area_tiles_unlock_schedule].tile },
		true
	)
	create_particles(

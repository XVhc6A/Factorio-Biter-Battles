...
local function create_particles(surface, name, position, amount, cause_position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:42')
...
local function get_amount(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:69')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:97')
	return amount
end

local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:100')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:103')
		return
	end
	if not scrap_yeild[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:106')
		return
	end
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:139')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:142')
		return
	end
	if not scrap_yeild[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:145')
		return
	end
	...
	if event.cause then
		if event.cause.valid then
			if event.cause.force.index == 2 or event.cause.force.index == 3 then
				entity.destroy()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_ores.lua:157')
				return
			end
		end
	end

...
local function create_projectile(surface, name, position, force, target, max_range)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:60')
...
local function get_near_range(range)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:72')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:80')
	return r
end

local function get_near_coord_modifier(range)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:83')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:91')
	return coord
end

local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:94')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:97')
		return
	end
	if not valid_container_types[entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:100')
		return
	end
...
local function on_tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:147')
	if not traps[game.tick] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/dangerous_goods.lua:149')
		return
	end

...
function init_player_weapon_damage(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games_balance.lua:93')
...
function init_enemy_weapon_damage()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games_balance.lua:103')
...
local function enemy_weapon_damage()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games_balance.lua:111')
...
local function research_finished(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games_balance.lua:124')

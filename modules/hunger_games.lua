...
local function anarchy_gui_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:14')
	if not player.gui.top["anarchy_group_button"] then
		local b = player.gui.top.add({
			type = "button",
			name = "anarchy_group_button",
			caption = "[Group]",
			tooltip = "Join / Create a group",
		})
...
local function anarchy_gui(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:33')
...
local function refresh_gui()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:157')
...
local function destroy_request_guis(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:173')
...
local function request_alliance(group, requesting_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:181')
	if not global.alliance_groups[group] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:183')
		return
	end
...
local function refresh_alliances()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:203')
...
local function new_group(frame, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:245')
	local new_group_name = frame.frame2.group_table.new_group_name.text
	local new_group_description = frame.frame2.group_table.new_group_description.text
	if new_group_name ~= "" and new_group_name ~= "Name" and new_group_description ~= "Description" then
		...
		if new_group_name == "spectator" or new_group_name == "player" then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:253')
			return
		end

		if #game.forces > 60 then
			player.print("There are too many existing groups.", { r = 0.90, g = 0.0, b = 0.0 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:258')
			return
		end

		if player.tag ~= "" then
			player.print("You are already in a group.", { r = 0.90, g = 0.0, b = 0.0 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:263')
			return
		end

		if string.len(new_group_name) > 32 then
			player.print("Group name is too long. 32 characters maximum.", { r = 0.90, g = 0.0, b = 0.0 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:268')
			return
		end
		...
		if string.len(new_group_description) > 128 then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:273')
			return
		end

		if global.alliance_groups[new_group_name] then
			player.print("This groupname already exists.", { r = 0.90, g = 0.0, b = 0.0 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:278')
			return
		end
		...
		local color =
			{ r = player.color.r * 0.7 + 0.3, g = player.color.g * 0.7 + 0.3, b = player.color.b * 0.7 + 0.3, a = 1 }
		...
		refresh_alliances()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:315')
		return
	end
end

local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:319')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:321')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:324')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:327')
		return
	end
	...
	if event.element.caption == "Accept" then
		...
		if not frame then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:335')
			return
		end
		...
		destroy_request_guis(requesting_player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:354')
		return
	end
	...
	if event.element.caption == "Deny" then
		local frame = event.element.parent
		if not frame then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:360')
			return
		end
		local group = frame.children[1].name
		local requesting_player = game.players[tonumber(frame.children[2].name)]
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:376')
		return
	end
	...
	if name == "create_new_group" then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:382')
		return
	end
		...
		if p.name == "groups_table" then
			if event.element.type == "button" and event.element.caption == "Join" then
				if global.spam_protection[tostring(player.name)] > game.tick then
					...
					log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:399')
					return
				end
			...
			if event.element.type == "button" and event.element.caption == "Leave" then
				...
				refresh_alliances()
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:414')
				return
			end
		end
	end
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:432')
...
local function on_console_chat(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:485')
	if not event.message then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:487')
		return
	end
	if event.message == "" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:490')
		return
	end
	if not event.player_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:493')
		return
	end
	local player = game.players[event.player_index]
	...
	if player.tag then
		if player.tag ~= "" then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:499')
			return
		end
	end
...
local function on_player_respawned(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:519')
	local player = game.players[event.player_index]
	player.insert({ name = "iron-plate", count = 8 })
end

local function on_built_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:524')
	local get_score = Score.get_table().score_table
	local entity = event.created_entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:528')
		return
	end
	local distance_to_center = math.sqrt(entity.position.x ^ 2 + entity.position.y ^ 2)
	if distance_to_center > 32 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hunger_games.lua:532')
		return
	end
	...
	if get_score then
		if get_score[player.force.name] then
			if get_score[player.force.name].players[player.name] then
				get_score[player.force.name].players[player.name].built_entities = get_score[player.force.name].players[player.name].built_entities
					- 1
			end
		end
	end

...
function Public.reset_table()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:66')
...
function Public.get(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:122')
	if key then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:124')
		return this[key]
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:126')
		return this
	end
end
...
function Public.get_value_from_player(key, value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:133')
	if key and value then
		if this.rpg_t[key] and this.rpg_t[key][value] then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:136')
			return this.rpg_t[key][value]
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:138')
		return false
	end
	if key then
		if this.rpg_t[key] then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:142')
			return this.rpg_t[key]
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:144')
		return false
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:146')
	return false
end
...
function Public.set_value_to_player(key, value, setter)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:153')
	if key and value then
		if this.rpg_t[key] and this.rpg_t[key][value] then
...
function Public.set(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:165')
	if key then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:167')
		return this[key]
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:169')
		return this
	end
end
...
function Public.toggle_debug()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:174')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:181')
...
function Public.debug_log(str)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:186')
	if not this.rpg_extra.debug then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:188')
		return
	end
	print(str)
end
...
function Public.set_surface_name(name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:195')
	if name then
		this.rpg_extra.surface_name = name
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:199')
		return error("No surface name given.", 2)
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:202')
...
function Public.enable_health_and_mana_bars(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:208')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:215')
...
function Public.enable_mana(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:220')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:227')
...
function Public.enable_wave_defense(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:233')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:240')
...
function Public.enable_flame_boots(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:245')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:252')
...
function Public.personal_tax_rate(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:257')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:264')
...
function Public.enable_stone_path(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:269')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:276')
...
function Public.enable_auto_allocate(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:281')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:288')
...
function Public.enable_one_punch(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:293')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:300')
...
function Public.enable_one_punch_globally(value)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:305')
	if value then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:312')
...
function Public.get_spells(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:317')
	if this.rpg_spells[key] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:319')
		return this.rpg_spells[key]
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:321')
...
function Public.disable_spell(key)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:329')
...
function Public.clear_spell_table()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:340')
	this.rpg_spells = {}
end
...
function Public.set_new_spell(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:346')
	if tbl then
		if not tbl.name then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:349')
			return error("A spell requires a name. <string>", 2)
		end
		if not tbl.obj_to_create then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:352')
			return error("A spell requires an object to create. <string>", 2)
		end
		if not tbl.target then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:355')
			return error("A spell requires position. <boolean>", 2)
		end
		if not tbl.amount then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:358')
			return error("A spell requires an amount of creation. <integer>", 2)
		end
		if not tbl.range then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:361')
			return error("A spell requires a range. <integer>", 2)
		end
		if not tbl.damage then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:364')
			return error("A spell requires damage. <damage-area=true/false>", 2)
		end
		if not tbl.force then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:367')
			return error("A spell requires a force. <string>", 2)
		end
		if not tbl.level then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:370')
			return error("A spell requires a level. <integer>", 2)
		end
		if not tbl.type then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:373')
			return error("A spell requires a type. <item/entity/special>", 2)
		end
		if not tbl.mana_cost then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:376')
			return error("A spell requires mana_cost. <integer>", 2)
		end
		if not tbl.tick then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:379')
			return error("A spell requires tick. <integer>", 2)
		end
		if not tbl.enabled then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:382')
...
function Public.rebuild_spells()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:391')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:406')
	return new_spells, spell_names
end

--- This will disable the cooldown of all spells.
function Public.disable_cooldowns_on_spells()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:410')
	local spells = this.rpg_spells
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:424')
	return new_spells
end

function Public.tweaked_crafting_items(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:427')
	if not tbl then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:429')
		return
	end

	if type(type) ~= "table" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:433')
		return
	end

	this.tweaked_crafting_items = tbl

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:438')
...
local on_init = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:449')
	Public.reset_table()
end

Event.on_init(on_init)

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/table.lua:455')
return Public

...
local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:25')
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:27')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:30')
		return
	end
	local element = event.element
	local player = game.players[event.player_index]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:35')
		return
	end

	local surface_name = RPG.get("rpg_extra").surface_name
	if sub(player.surface.name, 0, #surface_name) ~= surface_name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:40')
		return
	end

	if element.type ~= "sprite-button" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:44')
		return
	end
	...
	if element.caption ~= "✚" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:50')
		return
	end
	if element.sprite ~= "virtual-signal/signal-red" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:53')
		return
	end
	...
	if not rpg_t[player.index][index] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:60')
		return
	end
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:63')
		return
	end
	...
	if shift then
		...
		if not count then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:69')
			return
		end
	...
	elseif event.button == defines.mouse_button_type.right then
		for _ = 1, points_per_level, 1 do
			if rpg_t[player.index].points_to_distribute <= 0 then
				RPG_GUI.toggle(player, true)
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:82')
				return
			end
		...
		RPG_GUI.toggle(player, true)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:92')
		return
	end

	if rpg_t[player.index].points_to_distribute <= 0 then
		RPG_GUI.toggle(player, true)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:97')
		return
	end
	rpg_t[player.index].points_to_distribute = rpg_t[player.index].points_to_distribute - 1
	rpg_t[player.index][index] = rpg_t[player.index][index] + 1
...
local function train_type_cause(cause)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:108')
	local players = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:115')
	return players
end

local get_cause_player = {
	["character"] = function(cause)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:119')
		if not cause.player then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:121')
			return
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:123')
		return { cause.player }
	end,
	["combat-robot"] = function(cause)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:125')
		if not cause.last_user then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:127')
			return
		end
		if not game.players[cause.last_user.index] then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:130')
			return
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:132')
		return { game.players[cause.last_user.index] }
	end,
	["car"] = function(cause)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:134')
		local players = {}
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:148')
		return players
	end,
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:156')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:158')
		return
	end
	...
	if event.entity.last_user then
		if event.entity.type == "land-mine" then
			if event.cause then
				if event.cause.valid then
					if event.cause.force.index == event.entity.force.index then
						log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:167')
						return
					end
				end
			end
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:173')
			return
		end
	end
	...
	if not event.cause then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:190')
		return
	end

	if not event.cause.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:194')
		return
	end
	...
	if event.cause.force.index == 1 then
		if die_cause[type] then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:220')
			return
		end
	end
	...
	if event.cause.force.index == event.entity.force.index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:227')
		return
	end

	if not get_cause_player[event.cause.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:231')
		return
	end

	local players = get_cause_player[event.cause.type](event.cause)
	if not players then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:236')
		return
	end
	if not players[1] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:239')
		return
	end
	...
	if global.biter_health_boost then
		if enemy_types[event.entity.type] then
			...
			if health_pool then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:260')
				return
			end
		end
	end
...
local function regen_health_player(players)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:281')
	for i = 1, #players do
...
local function regen_mana_player(players)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:301')
	for i = 1, #players do
		local player = players[i]
...
local function give_player_flameboots(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:337')
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:339')
		return
	end
	if player.character.driving then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:342')
		return
	end
	...
	if not rpg_t[player.index].mana then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:348')
		return
	end

	if not rpg_t[player.index].flame_boots then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:352')
		return
	end
	...
	if rpg_t[player.index].mana <= 0 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:358')
		return
	end
...
local function one_punch(character, target, damage)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:383')
...
local function on_entity_damaged(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:449')
	if not event.cause then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:451')
		return
	end
	if not event.cause.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:454')
		return
	end
	if event.cause.force.index == 2 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:457')
		return
	end
	if event.cause.name ~= "character" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:460')
		return
	end

	if event.damage_type.name ~= "physical" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:464')
		return
	end

	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:468')
		return
	end
	if
	...
	then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:474')
		return
	end
	if not event.cause.player then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:477')
		return
	end
	...
	if sub(p.surface.name, 0, #surface_name) ~= surface_name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:484')
		return
	end
	...
	local damage = event.original_damage_amount
		+ event.original_damage_amount * Functions.get_melee_modifier(event.cause.player)
	...
	if enable_one_punch then
		if rpg_t[event.cause.player.index].one_punch then
			if math.random(0, 999) < Functions.get_one_punch_chance(event.cause.player) * 10 then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:517')
				return
			end
		end
	end
	...
	if global.biter_health_boost then
		...
		if health_pool then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:558')
			return
		end
	end
...
local function on_player_repaired_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:570')
	if math.random(1, 4) ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:572')
		return
	end
	...
	if not entity then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:578')
		return
	end

	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:582')
		return
	end

	if not entity.health then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:586')
		return
	end
	...
	if not player or not player.valid or not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:592')
		return
	end
	...
	if repair_speed <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:600')
		return
	end
...
local function on_player_rotated_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:605')
	local player = game.players[event.player_index]

	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:609')
		return
	end
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:612')
		return
	end

	local rpg_t = RPG.get("rpg_t")
	if rpg_t[player.index].rotated_entity_delay > game.tick then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:617')
		return
	end
...
local function on_player_changed_position(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:623')
	local player = game.players[event.player_index]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:626')
		return
	end
	...
	if math.random(1, 64) ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:636')
		return
	end
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:639')
		return
	end
	if player.character.driving then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:642')
		return
	end
...
local function on_player_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:653')
	local player = game.players[event.player_index]

	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:657')
		return
	end
...
local function on_pre_player_left_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:663')
	local player = game.players[event.player_index]

	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:667')
		return
	end
...
local function on_pre_player_mined_item(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:673')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:676')
		return
	end
	if building_and_mining_blacklist[entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:679')
		return
	end
	if entity.force.index ~= 3 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:682')
		return
	end
	local player = game.players[event.player_index]

	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:687')
		return
	end

	local surface_name = RPG.get("rpg_extra").surface_name
	if sub(player.surface.name, 0, #surface_name) ~= surface_name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:692')
		return
	end
	...
	then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:700')
		return
	end
...
local function on_player_crafted_item(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:726')
	if not event.recipe.energy then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:728')
		return
	end
	local player = game.players[event.player_index]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:732')
		return
	end

	if player.cheat_mode then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:736')
		return
	end
...
local function on_player_respawned(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:756')
	local player = game.players[event.player_index]
	local rpg_t = RPG.get("rpg_t")
	if not rpg_t[player.index] then
		Functions.rpg_reset_player(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:761')
		return
	end
	RPG_GUI.update_player_stats(player)
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:769')
	local player = game.players[event.player_index]
	local rpg_t = RPG.get("rpg_t")
	local rpg_extra = RPG.get("rpg_extra")
	if not rpg_t[player.index] then
	...
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:784')
		return
	end
	RPG_GUI.update_player_stats(player)
end
...
local function create_projectile(surface, name, position, force, target, max_range)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:789')
	if max_range then
...
local function get_near_coord_modifier(range)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:812')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:820')
	return coord
end

local function damage_entity(e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:823')
	if not e or not e.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:825')
		return
	end

	if not e.health then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:829')
		return
	end

	if e.force.name == "player" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:833')
		return
	end
	...
	if e.type == "entity-ghost" then
		e.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:840')
		return
	end
...
local function floaty_hearts(entity, c)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:849')
	...
	for _ = 1, c, 1 do
		...
		entity.surface.create_entity({
			...
			position = p,
			text = "♥",
			color = { math.random(150, 255), 0, 255 },
		})
	end
end

local function tame_unit_effects(player, entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:866')
...
local function on_player_used_capsule(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:887')
	local enable_mana = RPG.get("rpg_extra").enable_mana
	local surface_name = RPG.get("rpg_extra").surface_name
	if not enable_mana then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:891')
		return
	end
	...
	local player = game.players[event.player_index]
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:899')
		return
	end

	if not player.character or not player.character.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:903')
		return
	end

	if sub(player.surface.name, 0, #surface_name) ~= surface_name then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:907')
		return
	end
	...
	if not item then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:913')
		return
	end
	...
	if name ~= "raw-fish" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:919')
		return
	end
	...
	if not rpg_t[player.index].enable_entity_spawn then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:925')
		return
	end
	...
	if rpg_t[player.index].last_spawned >= game.tick then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:931')
	...
	if not object then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:939')
		return
	end

	if rpg_t[player.index].level < object.level then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:943')
		return p({ "rpg_main.low_level" }, Color.fail)
	end

	if not object.enabled then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:947')
		return
	end
	...
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:955')
		return
	end
	...
	if not Math2D.bounding_box.contains_point(area, player.position) then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:966')
		return
	end

	if mana < object.mana_cost then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:970')
	...
	elseif projectile_types[obj_name] then
		...
		elseif surface.can_place_entity({ name = obj_name, position = position }) then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1050')
			return
		end
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1068')
	return
end

local function on_player_changed_surface(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1071')
	local player = game.get_player(event.player_index)
	RPG_GUI.draw_level_text(player)
end

local function tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1076')
			...
			if player then
				if player ~= nil then
					...
					if not player.admin then
						...
						log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1112')
						return
					end
					if not param then
						log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/rpg/main.lua:1115')
						return
					end

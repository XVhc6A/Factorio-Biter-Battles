...
local function get_table(t)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:18')
	local key
	local value
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:25')
	return key, value
end

local function teleport(entity, pos, surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:28')
...
local function clear_surroundings(surface, pos)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:39')
...
local function transport_resources(container1, container2, transport_type)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:50')
	if container1 == nil or container2 == nil then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:52')
		return
	end

	if not container1.valid or not container2.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:56')
		return
	end

	local function average(c1c, c2c)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:59')
		local average_content = (c1c + c2c) / 2
		c1c = average_content
		c2c = average_content
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:63')
		return c1c, c2c
	end

	local function get_steam_temperature(container)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:66')
		local temperature = 0

		local function test_for(temp)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:69')
			local count = container.remove_fluid({ name = "steam", amount = 1, temperature = temp })
			if count ~= 0 then
				temperature = temp
			else
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:74')
				return
			end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:89')
		return temperature
	end

	local function divide_fluids()
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:92')
		...
		if
			(not name1 and not name2)
			or (name1 and name2 and name1 ~= name2)
			or (amount1 < 1 and amount2 < 1)
			or (amount1 == amount2)
		then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:105')
			return
		end
		if not name1 then
			name1 = name2
	...
	local function divide_contents()
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:130')
...
local function create_underground_floor(surface, size, going_down)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:157')
	local function tile_generation(floor_type, offset_pos, floor_pos, floor_area)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:158')
		local area = {}
...
local function create_main_surface(rebuild)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:202')
	...
	if not game.surfaces[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:208')
		return
	end

	if not game.surfaces[name].valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:212')
		return
	end
	...
	if rebuild then
		hidden_dimension.main_surface.reference = surface.create_entity({
			name = "car",
			position = position,
		...
		hidden_dimension.main_surface.reference
			.get_inventory(defines.inventory.fuel)
			.insert({ name = "coal", count = 100 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:230')
		return
	end
	if not hidden_dimension.main_surface.reference or not hidden_dimension.main_surface.reference.valid then
		...
		if hidden_dimension.logistic_research_level == 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:246')
			return
		end
...
local function create_underground_surfaces()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:252')
	local function create_underground(floor_table, name, going_down)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:253')
		...
		floor_table.going_up.reference = floor_table.surface.create_entity({
			name = "car",
			position = { 0, -6 },
			force = game.forces.enemy,
			create_build_effect_smoke = false,
		...
		if going_down then
			floor_table.going_down.reference = floor_table.surface.create_entity({
				name = "car",
				position = { 0, 4 },
				force = game.forces.enemy,
				create_build_effect_smoke = false,
...
local function reset_surface()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:335')
	HDT.reset_table()
	local hidden_dimension = HDT.get("hidden_dimension")
...
local function logistic_update()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:351')
	local hidden_dimension = HDT.get("hidden_dimension")
	local name = hidden_dimension.hd_surface

	if not game.surfaces[name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:356')
		return
	end

	if not game.surfaces[name].valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:360')
		return
	end

	local function energy_update(t)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:363')
		local g = 0
		local c = 0
		for k, v in pairs(t) do
			if v.valid then
	...
	local function entrance_transport_resources(transport1, transport2)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:380')
...
local function on_research_finished(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:418')
	local hidden_dimension = HDT.get("hidden_dimension")

	if
		event.research.name == "automation"
		or event.research.name == "automation-2"
		or event.research.name == "automation-3"
	then
...
local function through_teleporter_update()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:452')
	local hidden_dimension = HDT.get("hidden_dimension")
	local function teleport_players_around(source, destination)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:454')
		if source == nil or source.valid ~= true then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:456')
			return
		end
		if destination == nil or not destination.valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:459')
			return
		end

		local function surface_play_sound(sound_path, surface, pos)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:462')
		...
		local to_teleport_out_entity_list = source.surface.find_entities_filtered({
			area = {
	...
	if
		hidden_dimension.level_1
		and hidden_dimension.level_1.going_up
		and hidden_dimension.level_1.going_up.reference
	then
	...
	if
		hidden_dimension.level_1
		and hidden_dimension.level_1.going_down
		and hidden_dimension.level_1.going_down.reference
	then
	...
	if
		hidden_dimension.level_2
		and hidden_dimension.level_2.going_up
		and hidden_dimension.level_2.going_up.reference
	then
		teleport_players_around(
			hidden_dimension.level_2.going_up.reference,
			hidden_dimension.level_1.going_down.reference
...
local function on_entity_cloned(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:526')
	local hidden_dimension = HDT.get("hidden_dimension")
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:536')
...
local function on_tick(e)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:544')
	if e.tick % 5 then
		logistic_update()
		if e.tick % 30 then
			create_main_surface()
...
local function on_init()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:554')
	local hidden_dimension = HDT.get("hidden_dimension")
...
function Public.init(args)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:565')
	local hidden_dimension = HDT.get("hidden_dimension")
	if args then
...
function Public.create_chests(surface, level, build_type)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:576')
	...
	local function add_container(name, pos, direction, type)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:615')
		local container_entity
		container_entity = logistic_building.surface.find_entity(
			name,
		...
		if container_entity == nil then
			...
			if name == "loader" or name == "fast-loader" or name == "express-loader" then
				container_entity = logistic_building.surface.create_entity({
					name = name,
					position = pos2,
		...
		container_entity.minable = false
		container_entity.destructible = false
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:659')
...
function Public.upgrade_transport_buildings(level)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:680')
	local function upgrade(transport, building_type)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:681')
		local function copy_chest_content(content, chest)
			log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:682')
		...
		if transport.reference == nil or transport.reference.valid ~= true then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:689')
			return
		end
		if transport.entities.chest_1 == nil or transport.entities.chest_1.valid ~= true then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:692')
			return
		end
...
function Public.create_chests_logistics(level)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:725')
	local hidden_dimension = HDT.get("hidden_dimension")
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/hidden_dimension/main.lua:745')
return Public

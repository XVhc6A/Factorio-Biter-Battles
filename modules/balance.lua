...
local function player_ammo_starting_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:2')
	local data = {
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:19')
	return data
end

local function player_gun_speed_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:22')
	local data = {
		["artillery-shell"] = -0.75,
		["biological"] = -0.5,
		["bullet"] = -0.55,
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:39')
	return data
end
local function player_ammo_research_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:41')
	local data = {
		["artillery-shell"] = -0.75,
		["biological"] = -0.5,
		["bullet"] = -0.5,
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:58')
	return data
end

local function player_turrets_research_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:61')
	local data = {
		["gun-turret"] = -0.75,
		["flamethrower-turret"] = -0.75,
	}
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:66')
	return data
end

local function enemy_ammo_starting_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:69')
	local data = {
		["artillery-shell"] = 3,
		["biological"] = 3,
		["bullet"] = 2,
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:86')
	return data
end

local function enemy_ammo_evolution_modifiers()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:89')
	local data = {
		["artillery-shell"] = 1,
		["biological"] = 2,
		["bullet"] = 1,
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:106')
	return data
end

local function init_player_weapon_damage(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:109')
...
local function init_enemy_weapon_damage()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:119')
...
local function enemy_weapon_damage()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:127')
	local e = game.forces.enemy
...
local function research_finished(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/balance.lua:140')

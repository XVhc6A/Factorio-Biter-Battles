...
local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_scrap.lua:117')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_scrap.lua:120')
		return
	end
	if entity.name ~= "mineable-wreckage" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/mineable_wreckage_yields_scrap.lua:123')
		return
	end
	...
	local amount_bonus = (game.forces.enemy.evolution_factor * 2)
		+ (game.forces.player.mining_drill_productivity_bonus * 2)

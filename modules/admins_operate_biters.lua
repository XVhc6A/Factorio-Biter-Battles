...
local function shuffle(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:32')
	local size = #tbl
	for i = size, 1, -1 do
		local rand = math_random(size)
		tbl[i], tbl[rand] = tbl[rand], tbl[i]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:38')
	return tbl
end

local function is_closer(pos1, pos2, pos)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:41')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:42')
	return ((pos1.x - pos.x) ^ 2 + (pos1.y - pos.y) ^ 2) < ((pos2.x - pos.x) ^ 2 + (pos2.y - pos.y) ^ 2)
end

local function shuffle_distance(tbl, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:45')
	local size = #tbl
	for i = size, 1, -1 do
		local rand = math_random(size)
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:53')
	return tbl
end

local function get_evo(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:56')
...
local function place_nest_near_unit_group(group)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:61')
	if not global.biter_command.buildings then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:63')
		return false
	end
	if not group.members then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:66')
		return false
	end
	if #group.members < 5 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:69')
		return false
	end
	...
	for i = 1, 5, 1 do
		if not units[i].valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:75')
			return false
		end
	end
	...
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:84')
		return false
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:92')
	return true
end

local function build_worm(group)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:95')
	if not global.biter_command.buildings then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:97')
		return false
	end
	if not group.members then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:100')
		return false
	end
	if #group.members < 5 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:103')
		return false
	end
	local units = group.members
	shuffle(units)
	for i = 1, 5, 1 do
		if not units[i].valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:109')
			return false
		end
	end
	local position = group.surface.find_non_colliding_position("assembling-machine-1", group.position, 8, 1)
	local worm = worm_raffle[math_random(
		1 + math_floor(group.force.evolution_factor * 8),
		math_floor(1 + group.force.evolution_factor * 16)
	)]
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:118')
		return false
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:126')
	return true
end

local function flying_text(message, action, position, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:129')
	local texts = {
	...
	if message then
		...
		player.create_local_flying_text({
			text = texts[action][math_random(1, #texts[action])],
			position = position,
			color = colors[action],
		})
	end
...
local function move_to(position, distraction)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:160')
	local command = {
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:167')
	return command
end

-- local function attackmaincommand(target)
log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:170')
...
local function attackareacommand(position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:182')
	local command = {
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:189')
	return command
end

local function attackobstaclescommand(surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:192')
	local commands = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:213')
	return commands
end

local function get_coords(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:216')
	local position
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:231')
	return position
end
...
local function pan(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:236')
	source_player.open_map(group.position, 0.5)
end

local function teleport(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:240')
...
local function disband(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:248')
	flying_text(nil, 4, group.position, source_player)
	group.destroy()
end

local function movetome(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:253')
...
local function movetoposition(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:258')
...
local function patroltome(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:268')
...
local function patroltoposition(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:273')
	local position = get_coords(group, source_player)
	if position then
...
local function settle(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:283')
	...
	if success then
		...
		flying_text(nil, 2, group.position, source_player)
		source_player.print(
			"Settling new nest failed. Check if group has enough members(5+) and there is empty space (or nests are disabled)."
		)
	end
end

local function siege(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:295')
	...
	if success then
		...
		flying_text(nil, 2, group.position, source_player)
		source_player.print(
			"Making worm failed. Check if group has enough members(5+) and there is empty space (or worms are disabled)."
		)
	end
end

local function report(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:307')
	local status = group.state
	local states = {
		"gathering",
		"moving",
		"attacking distraction",
		"attacking target",
		"finished",
		"pathfinding",
		"wander in group",
...
local function attackenemiesaround(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:321')
...
local function attackobstaclesaround(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:326')
...
local function attackenemiesaroundme(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:341')
	group.set_command(attackareacommand(source_player.position))
	flying_text(nil, 3, group.position, source_player)
end

local function attackobstaclesaroundme(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:346')
...
local function addunitsaroundme(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:361')
	local units = source_player.surface.find_entities_filtered({
...
local function addunits(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:373')
	local units = source_player.surface.find_entities_filtered({
...
local function forcemove(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:385')
	group.start_moving()
	flying_text(nil, 1, group.position, source_player)
end

local function creategroup(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:390')
...
local function set_directions(changedx, changedy, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:395')
	if source_player.gui.screen["biter_panel"] then
		local x = tonumber(source_player.gui.screen["biter_panel"]["coords"]["coord_x"].text)
		local y = tonumber(source_player.gui.screen["biter_panel"]["coords"]["coord_y"].text)
		if x == nil or x == "nil" then
...
local function nw(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:412')
	set_directions(-25, -25, source_player)
end

local function n(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:416')
	set_directions(0, -25, source_player)
end

local function ne(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:420')
	set_directions(25, -25, source_player)
end

local function w(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:424')
	set_directions(-25, 0, source_player)
end

local function e(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:428')
	set_directions(25, 0, source_player)
end

local function sw(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:432')
	set_directions(-25, 25, source_player)
end

local function s(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:436')
	set_directions(0, 25, source_player)
end

local function se(source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:440')
	set_directions(25, 25, source_player)
end

local function center(group, source_player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:444')
	if source_player.gui.screen["biter_panel"] then
		source_player.gui.screen["biter_panel"]["coords"]["coord_x"].text = group.position.x
		source_player.gui.screen["biter_panel"]["coords"]["coord_y"].text = group.position.y
	end
...
local function top_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:453')
	if player.gui.top["biter_commands"] then
		if global.biter_command.enabled or global.biter_command.whitelist[player.name] == true then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:457')
			return
		else
			--player.gui.top["biter_commands"].destroy()
			player.gui.top["biter_commands"].visible = false
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:461')
			return
		end
	end
...
local function show_info(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:478')
	if player.gui.screen["biter_comm_info"] then
		player.gui.screen["biter_comm_info"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:481')
		return
	end
	local frame = player.gui.screen.add({
		type = "frame",
		name = "biter_comm_info",
		caption = "Biter Commander needs halp",
		direction = "vertical",
	})
	...
	frame.add({
		type = "label",
		caption = "If you input invalid coordinates, they get rewritten to current group's position.",
	})
...
local function build_groups(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:506')
	local groups = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:522')
	return groups
end

local function biter_panel(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:525')
	if player.gui.screen["biter_panel"] then
		player.gui.screen["biter_panel"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:528')
		return
	end

	local frame = player.gui.screen.add({
		type = "frame",
		caption = "Biter Commander",
		name = "biter_panel",
		direction = "vertical",
	})
	...
	local drop_down =
		t0.add({ type = "drop-down", name = "group_select", items = groups, selected_index = selected_index })
	...
	local buttons = {
		...
		t2.add({
			...
			caption = "Move to me",
			name = "movetome",
			tooltip = "Gives group order to move to your position.",
		}),
		t2.add({
			type = "button",
			caption = "Move to position",
			name = "movetoposition",
			tooltip = "Sends group to position with coordinates entered below.",
		}),
		t2.add({
			type = "button",
			caption = "Patrol to me ",
			name = "patroltome",
			tooltip = "Gives group order to move to your position and engage any enemy during movement.",
		}),
		t2.add({
			type = "button",
		...
		t3.add({
			...
			caption = "Settle nest",
			name = "settle",
			tooltip = "Group creates base. Costs 5 units.",
		}),
		t3.add({
			type = "button",
			caption = "Build worm",
			name = "siege",
			tooltip = "Group builds worm turret. Costs 5 units.",
		}),
		t4.add({
			type = "button",
			caption = "Attack area",
			name = "attackenemiesaround",
			tooltip = "Group attacks enemy things around self.",
		}),
		t4.add({
			type = "button",
			caption = "Attack obstacles",
			name = "attackobstaclesaround",
			tooltip = "Group attacks obstacles around self.",
		}),
		t4.add({
			type = "button",
			caption = "Attack my area",
			name = "attackenemiesaroundme",
			tooltip = "Group attacks enemy things around your position.",
		}),
		t4.add({
			type = "button",
			caption = "Attack my obstacles",
			name = "attackobstaclesaroundme",
			tooltip = "Group attacks obstacles around your position.",
		}),
		...
		t5.add({
			...
			caption = "Force Move",
			name = "forcemove",
			tooltip = "Makes group to start moving even if gathering is not done (unstuck).",
		}),
		t5.add({
			type = "button",
			caption = "Add units around me",
			name = "addunitsaroundme",
			tooltip = "Adds units around you to selected unit group.",
		}),
		t5.add({
			type = "button",
			caption = "Add units",
			name = "addunits",
			tooltip = "Adds units around group to it.",
		}),
		t5.add({
			type = "button",
			caption = "Create group",
			name = "creategroup",
			tooltip = "Creates new group on player position",
		}),
...
local function refresh_groups(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:726')
	local groups = build_groups(player)
	player.gui.screen["biter_panel"]["top"]["group_select"].items = groups
end

local function on_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:731')
	if not event then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:733')
		return
	end
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:736')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:739')
		return
	end
	...
	if event.element.name == "biter_commands" then --top button press
		if global.biter_command.enabled or global.biter_command.whitelist[player.name] == true then
			biter_panel(player)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:745')
			return
		else
			top_button(player)
			player.print("Biter commander module is disabled.")
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:749')
			return
		end
	else
		if global.biter_command.enabled or global.biter_command.whitelist[player.name] == true then
	...
	if event.element.type ~= "button" and event.element.type ~= "sprite-button" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:757')
		return
	end
	...
	if name == "close_biters" then
		biter_panel(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:763')
		return
	end
	if name == "info" then
		show_info(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:767')
		return
	end
	if name == "close_info" then
		show_info(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:771')
		return
	end
	if comm_functions[name] then
		local target_group_id =
			event.element.parent.parent["top"]["group_select"].items[event.element.parent.parent["top"]["group_select"].selected_index]
		if not target_group_id then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:777')
			return
		end
		if target_group_id == "Select Group" then
			player.print("No target group selected.", { r = 0.88, g = 0.88, b = 0.88 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:781')
			return
		end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:794')
		return
	end

	if comm_global_functions[name] then
		comm_global_functions[name](player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:799')
		return
	end
end

local function refresh_panel()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:803')
...
local function on_player_joined_game(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:811')
	top_button(game.players[event.player_index])
end

local function on_unit_group_created(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:815')
	if event and event.group and event.group.valid then
		global.biter_command.active_unit_groups[event.group.group_number] =
			{ id = event.group.group_number, group = event.group }
		refresh_panel()
	end
end

local function on_unit_removed_from_group(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/admins_operate_biters.lua:823')
	if event and event.group and event.group.valid then

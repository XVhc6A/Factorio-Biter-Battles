...
local function create_visuals(source_entity, target_entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:17')
	if not additional_visual_effects then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:19')
		return
	end
...
local function do_splash_damage_around_entity(source_entity, player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:62')
	if not do_splash_damage then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:64')
		return
	end
...
local function on_entity_damaged(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:103')
	if not event.cause then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:105')
		return
	end
	if event.cause.name ~= "character" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:108')
		return
	end
	if event.damage_type.name ~= "physical" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:111')
		return
	end
	if event.original_damage_amount ~= 100 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:114')
		return
	end

	local player = event.cause
	if player.shooting_state.state == defines.shooting.not_shooting then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:119')
		return
	end
	local selected_weapon = player.get_inventory(defines.inventory.character_guns)[player.selected_gun_index]
	if not selected_weapon.valid_for_read then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:123')
		return
	end
	if selected_weapon.name ~= "railgun" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/modules/railgun_enhancer.lua:126')
		return
	end

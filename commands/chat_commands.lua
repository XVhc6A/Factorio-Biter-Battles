...
local function chat_with_team(message, team)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/commands/chat_commands.lua:4')
	...
	if player and player.valid then
		...
		if a then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/commands/chat_commands.lua:17')
			return
		end

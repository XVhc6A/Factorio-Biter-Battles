...
local function get_raffle_keys()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:416')
	local raffle_keys = {}
	for i = 1, size_of_item_names, 1 do
		raffle_keys[i] = i
	end
	table_shuffle_table(raffle_keys)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:422')
	return raffle_keys
end

function Public.roll_item_stack(remaining_budget, blacklist)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:425')
	if remaining_budget <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:427')
		return
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:453')
	return { name = item_name, count = item_count }
end

local function roll_item_stacks(remaining_budget, max_slots, blacklist)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:456')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:470')
	return item_stack_set, item_stack_set_worth
end

function Public.roll(budget, max_slots, blacklist)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:473')
	if not budget then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:475')
		return
	end
	if not max_slots then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:478')
		return
	end
	...
	if budget == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:490')
		return
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:509')
	return final_stack_set
end

--tier = float 0-1; 1 = everything unlocked
function Public.get_tech_blacklist(tier)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:513')
	local blacklist = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:520')
	return blacklist
end

function Public.get_item_value(item)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:523')
	local value = item_worths[item]
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:525')
	return value
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/loot_raffle.lua:528')
return Public

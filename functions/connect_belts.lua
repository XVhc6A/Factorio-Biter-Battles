...
local function get_optimal_direction(entity, direction_tendency)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/connect_belts.lua:14')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/connect_belts.lua:53')
	return optimal_direction
end

function connect_belts(entities, d)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/connect_belts.lua:56')
	for a = 1, 4, 1 do
		local r = d
		if not r then
			r = math.random(1, 4)
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/connect_belts.lua:68')

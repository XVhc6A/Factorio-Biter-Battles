...
local function reset_forces(new_surface, old_surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:5')
...
local function teleport_players(surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:22')
...
local function equip_players(player_starting_items)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:35')
...
function Public.soft_reset_map(old_surface, map_gen_settings, player_starting_items)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:50')
	...
	local new_surface = game.create_surface(
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:85')
	return new_surface
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/soft_reset.lua:88')
return Public

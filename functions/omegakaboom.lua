...
local function create_projectile(surface, pos, projectile)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:12')
...
local function omegakaboom(surface, center_pos, projectile, radius, density)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:22')
	local positions = {}
	...
	if #positions == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:37')
		return
	end
	local t = 1
...
local function on_tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:54')
	if not traps[game.tick] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:56')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/omegakaboom.lua:70')
return omegakaboom

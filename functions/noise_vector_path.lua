...
local function get_brush(size)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:4')
	local vectors = {}
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:13')
	return vectors
end

function noise_vector_entity_path(surface, entity_name, position, base_vector, length, collision)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:16')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:51')
	return entities
end

function noise_vector_tile_path(surface, tile_name, position, base_vector, length, brush_size, whitelist)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:54')
	local seed_1 = math.random(1, 10000000)
	local seed_2 = math.random(1, 10000000)
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/noise_vector_path.lua:98')
	return tiles
end

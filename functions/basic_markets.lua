...
local function get_types()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:146')
	local types = {}
	for k, v in pairs(market) do
		types[#types + 1] = k
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:151')
	return types
end

local function get_resource_market_sells()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:154')
	local sells = {
		...
		{
			price = { { "coin", math.random(8, 16) } },
			offer = { type = "give-item", item = "uranium-ore", count = 50 },
		},
		{
			price = { { "coin", math.random(2, 4) } },
			offer = {
				type = "give-item",
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:175')
	return sells
end

local function get_resource_market_buys()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:178')
	local buys = {
		...
		{
			price = { { "lubricant-barrel", 1 } },
			offer = { type = "give-item", item = "coin", count = math.random(3, 6) },
		},
		{
			price = { { "sulfuric-acid-barrel", 1 } },
			offer = { type = "give-item", item = "coin", count = math.random(4, 8) },
		},
		{
			price = { { "light-oil-barrel", 1 } },
			offer = { type = "give-item", item = "coin", count = math.random(2, 4) },
		},
		{
			price = { { "heavy-oil-barrel", 1 } },
			offer = { type = "give-item", item = "coin", count = math.random(2, 4) },
		},
		{
			price = { { "petroleum-gas-barrel", 1 } },
			offer = { type = "give-item", item = "coin", count = math.random(3, 5) },
		},
	}
	table.shuffle_table(buys)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:209')
	return buys
end

local function get_market_item_list(market_types, rarity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:212')
	if rarity < 1 then
		rarity = 1
	end
	if rarity > 10 then
	...
	if #list == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:236')
		return false
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:238')
	return list
end

local function get_random_market_item_list(rarity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:241')
	local types = get_types()
	table.shuffle_table(types)
	for i = 1, #types, 1 do
		local items = get_market_item_list({ types[i] }, rarity)
		if items then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:247')
			return items
		end
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:250')
	return false
end

function Public.mountain_market(surface, position, rarity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:253')
	local types = get_types()
	table.shuffle_table(types)
	local items = get_market_item_list({ types[1], types[2], types[3] }, rarity)
	if not items then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:258')
		return
	end
	if #items > 0 then
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:293')
	return market
end

function Public.super_market(surface, position, rarity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:296')
	local items = get_market_item_list(get_types(), rarity)
	if not items then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:299')
		return
	end
	if #items > 0 then
		table.shuffle_table(items)
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:325')
	return market
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/basic_markets.lua:328')
return Public

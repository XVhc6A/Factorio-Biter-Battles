...
local function create_particles(surface, position, amount)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:12')
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:14')
		return
	end
...
local function spawn_biter(surface, position, evolution)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:32')
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:34')
		return
	end
	...
	for i = 1, 8, 1 do
		...
		if r <= current_chance then
			...
			if not p then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:64')
				return
			end
			surface.create_entity({ name = biter_name, position = p, force = "enemy" })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:67')
			return
		end
	end
end
...
local function unearthing_biters(surface, position, amount)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:72')
	if not surface then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:74')
		return
	end
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:77')
		return
	end
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:80')
		return
	end
	if not position.x then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:83')
		return
	end
	if not position.y then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:86')
		return
	end
...
local function on_tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:114')
	if not traps[game.tick] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:116')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/unearthing_biters.lua:132')

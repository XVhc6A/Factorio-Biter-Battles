...
local function create_flying_text(surface, position, text)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:32')
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:34')
		return
	end
	...
	if text == "..." then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:43')
		return
	end
...
local function create_kaboom(surface, position, name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:48')
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:50')
		return
	end
...
local function tick_tack_trap(surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:77')
	if not surface then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:79')
		return
	end
	if not surface.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:82')
		return
	end
	if not position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:85')
		return
	end
	if not position.x then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:88')
		return
	end
	if not position.y then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:91')
		return
	end
...
local function on_tick()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:120')
	if not traps[game.tick] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:122')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/functions/tick_tack_trap.lua:138')

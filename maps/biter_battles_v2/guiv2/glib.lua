--- This is taken from https://mods.factorio.com/mod/custom-cursor-split
--- which is an updated version of https://github.com/CodeGreen0386/glib
--- We should consider if using this type of framework is worth it.  The
--- only reason why I used this first is because I wanted to map the gui
--- out first.

local mod_name = "__factorio_biter_battles__/handlers"

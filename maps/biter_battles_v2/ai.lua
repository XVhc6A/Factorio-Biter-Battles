...
local function get_target_entity(force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:43')
	...
	if not target_entity then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:48')
		return
	end
	for _ = 1, 2, 1 do
	...
	if not target_entity then
		print("Unable to get target entity for " .. force_name .. ".")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:58')
		return
	end
	--print("Target entity for " .. force_name .. ": " .. target_entity.name .. " at x=" .. target_entity.position.x .. " y=" .. target_entity.position.y)
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:61')
	return target_entity
end

local function get_threat_ratio(biter_force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:64')
	if global.bb_threat[biter_force_name] <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:66')
		return 0
	end
	local t1 = global.bb_threat["north_biters"]
	local t2 = global.bb_threat["south_biters"]
	if t1 == 0 and t2 == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:71')
		return 0.5
	end
	if t1 < 0 then
		t1 = 0
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:81')
	return ratio
end

local function is_biter_inactive(biter, unit_number, biter_force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:84')
	if not biter.entity then
		if global.bb_debug then
			print("BiterBattles: active unit " .. unit_number .. " removed, possibly died.")
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:89')
		return true
	end
	if not biter.entity.valid then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:95')
		return true
	end
	if not biter.entity.unit_group then
		if global.bb_debug then
			print(
				"BiterBattles: active unit "
					.. unit_number
					.. "  at x"
					.. biter.entity.position.x
					.. " y"
					.. biter.entity.position.y
					.. " removed, had no unit group."
			)
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:109')
		return true
	end
	if not biter.entity.unit_group.valid then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:115')
		return true
	end
		...
		if global.bb_debug then
			print(
				"BiterBattles: "
					...
					.. " unit "
					.. unit_number
					.. " timed out at tick age "
					.. game.tick - biter.active_since
					.. "."
			)
		end
		biter.entity.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:130')
		return true
	end
end

Public.send_near_biters_to_silo = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:134')
	if game.ticks_played < 108000 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:136')
		return
	end
	if not global.rocket_silo["north"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:139')
		return
	end
	if not global.rocket_silo["south"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:142')
		return
	end
...
local function get_random_spawner(biter_force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:168')
	local spawners = global.unit_spawners[biter_force_name]
	local size_of_spawners = #spawners

	for _ = 1, 256, 1 do
		if size_of_spawners == 0 then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:174')
			return
		end
		local index = math_random(1, size_of_spawners)
		local spawner = spawners[index]
		if spawner and spawner.valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:179')
			return spawner
		else
...
local function select_units_around_spawner(spawner, force_name, side_target)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:187')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:248')
	return valid_biters
end

local function send_group(unit_group, force_name, side_target)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:251')
	local target
	if side_target then
		target = side_target
	else
	...
	if not target then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:260')
		return
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:300')
	return true
end

local function get_unit_group_position(spawner)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:303')
	local p
	...
	if not p then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:315')
		return
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:317')
	return p
end

local function get_nearby_biter_nest(target_entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:320')
	...
	if not spawner then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:325')
		return
	end
	...
	if not spawner then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:339')
		return
	end
	--print("Nearby biter nest found at x=" .. spawner.position.x .. " y=" .. spawner.position.y .. ".")
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:342')
	return spawner
end

local function create_attack_group(surface, force_name, biter_force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:345')
	local threat = global.bb_threat[biter_force_name]
	if threat <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:348')
		return false
	end
	...
	if not side_target then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:354')
		return
	end
	...
	if not spawner then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:360')
		return
	end

	local unit_group_position = get_unit_group_position(spawner)
	if not unit_group_position then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:365')
		return
	end

	local units = select_units_around_spawner(spawner, force_name, side_target)
	if not units then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:370')
		return
	end
...
Public.pre_main_attack = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:381')
...
Public.perform_main_attack = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:397')
...
Public.post_main_attack = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:408')
	global.main_attack_wave_amount = 0
...
Public.unlock_satellite = function(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:418')
	-- Skip unrelated events
	if event.research.name ~= "speed-module-3" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:421')
		return
	end
...
Public.raise_evo = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:430')
	if global.freeze_players then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:432')
		return
	end
	if
	...
	then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:438')
		return
	end
	if game.ticks_played < 7200 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:441')
		return
	end
	...
	if not a_team_has_players then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:464')
		return
	end
...
Public.reset_evo = function()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:469')
	...
	if game.ticks_played >= global.difficulty_votes_timeout then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:472')
		return
	end

	local amount = global.total_passive_feed_redpotion
	if amount < 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:477')
		return
	end
	global.total_passive_feed_redpotion = 0
...
function Public.subtract_threat(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:489')
	if not threat_values[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:491')
		return
	end

	global.bb_threat[entity.force.name] = global.bb_threat[entity.force.name] - threat_values[entity.name]

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:496')
	return true
end
...
local function likely_biter_name(force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:511')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:526')
...
local function reanimate_unit(id)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:540')
...
local function _reanimate_units(id, cycles)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:579')
	repeat
...
function Public.reanimate_units()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:587')
...
Public.schedule_reanimate = function(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:605')
	...
	if global.server_restart_timer ~= nil then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:614')
		return
	end
	...
	if chance <= 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:628')
		return
	end

	local reanimate = math.random(1, 100) <= chance
	if not reanimate then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:633')
		return
	end
...
function Public.empty_reanim_scheduler()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:640')
	for force, id in pairs(global.dead_units) do
		-- Check for each side if there are any biters to reanimate.
		if not fifo.empty(id) then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:644')
			return false
		end
	end

	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:648')
	return true
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/ai.lua:651')
return Public

...
local function createTrollSong()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:8')
...
function Public.initial_setup()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:45')
...
function Public.playground_surface()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:131')
	...
	map_gen_settings.autoplace_controls = {
		...
		["trees"] = {
			frequency = math.random(8, 28) * 0.1,
			size = math.random(6, 14) * 0.1,
			richness = math.random(2, 4) * 0.1,
		},
...
function Public.draw_structures()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:159')
...
function Public.tables()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:170')
...
function Public.load_spawn()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:269')
	local surface = game.surfaces[global.bb_surface_name]
...
function Public.forces()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:294')
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/init.lua:381')
return Public

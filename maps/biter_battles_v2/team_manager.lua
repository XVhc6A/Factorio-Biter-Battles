...
local function get_player_array(force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:9')
	local a = {}
	for _, p in pairs(game.forces[force_name].connected_players) do
		a[#a + 1] = p.name
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:14')
	return a
end

local function freeze_players()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:17')
	if not global.freeze_players then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:19')
		return
	end
...
local function unfreeze_players()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:42')
	local p = game.permissions.get_group("Default")
	for action_name, _ in pairs(defines.input_action) do
...
local function leave_corpse(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:51')
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:53')
		return
	end
...
local function switch_force(player_name, force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:88')
	if not game.players[player_name] then
		game.print("Team Manager >> Player " .. player_name .. " does not exist.", { r = 0.98, g = 0.66, b = 0.22 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:91')
		return
	end
	if not game.forces[force_name] then
		game.print("Team Manager >> Force " .. force_name .. " does not exist.", { r = 0.98, g = 0.66, b = 0.22 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:95')
		return
	end
...
function Public.draw_top_toggle_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:114')
...
local function draw_manager_gui(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:129')
...
local function set_custom_team_name(force_name, team_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:251')
	if team_name == "" then
		global.tm_custom_name[force_name] = nil
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:254')
		return
	end
	if not team_name then
		global.tm_custom_name[force_name] = nil
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:258')
		return
	end
...
local function custom_team_name_gui(player, force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:263')
	if player.gui.center["custom_team_name_gui"] then
		player.gui.center["custom_team_name_gui"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:266')
		return
	end
	local frame = player.gui.center.add({
		type = "frame",
		name = "custom_team_name_gui",
		caption = "Set custom team name:",
		direction = "vertical",
	})
...
local function team_manager_gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:298')
	...
	if game.forces[name] then
		if not player.admin then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:305')
			return
		end
		custom_team_name_gui(player, name)
		player.gui.center["team_manager_gui"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:309')
		return
	end

	if name == "team_manager_close" then
		player.gui.center["team_manager_gui"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:314')
		return
	end
	...
	if name == "team_manager_activate_tournament" then
		if not player.admin then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:320')
			return
		end
		if global.tournament_mode then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:326')
			return
		end
		global.tournament_mode = true
		draw_manager_gui(player)
		game.print(">>> Tournament Mode has been enabled!", { r = 225, g = 0, b = 0 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:331')
		return
	end
	...
	if name == "team_manager_freeze_players" then
		if global.freeze_players then
			if not player.admin then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:338')
				return
			end
			...
			unfreeze_players()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:344')
			return
		end
		if not player.admin then
			player.print("Only admins can freeze players.", { r = 175, g = 0, b = 0 })
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:348')
			return
		end
		...
		freeze_players()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:354')
		return
	end
	...
	if name == "team_manager_activate_training" then
		if not player.admin then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:360')
			return
		end
		if global.training_mode then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:367')
			return
		end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:373')
		return
	end

	if not event.element.parent then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:377')
		return
	end
	local element = event.element.parent
	if not element.parent then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:381')
		return
	end
	local element = element.parent
	if element.name ~= "team_manager_root_table" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:385')
		return
	end
	if not player.admin then
		player.print("Only admins can manage teams.", { r = 175, g = 0, b = 0 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:389')
		return
	end

	local listbox =
		player.gui.center["team_manager_gui"]["team_manager_root_table"]["team_manager_list_box_" .. tonumber(name)]
	local selected_index = listbox.selected_index
	if selected_index == 0 then
		player.print("No player selected.", { r = 175, g = 0, b = 0 })
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:397')
		return
	end
...
function Public.gui_click(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:412')
	if not event.element then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:414')
		return
	end
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:417')
		return
	end
	local player = game.players[event.player_index]
	local name = event.element.name
	...
	if name == "team_manager_toggle_button" then
		if player.gui.center["team_manager_gui"] then
			player.gui.center["team_manager_gui"].destroy()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:425')
			return
		end
		draw_manager_gui(player)
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:428')
		return
	end
	...
	if player.gui.center["custom_team_name_gui"] then
		if name == "custom_team_name_gui_set" then
			...
			player.gui.center["custom_team_name_gui"].destroy()
			draw_manager_gui(player)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:442')
			return
		end
		if name == "custom_team_name_gui_close" then
			player.gui.center["custom_team_name_gui"].destroy()
			draw_manager_gui(player)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:447')
			return
		end
	end
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/team_manager.lua:452')
return Public

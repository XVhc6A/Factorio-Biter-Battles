...
local function proj_buff(current_value, force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:17')
...
local function laser_buff(current_value, force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:24')
...
local function flamer_buff(current_value_ammo, current_value_turret, force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:33')
...
local balance_functions = {
	["refined-flammables"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:54')
		flamer_buff(
	...
	["refined-flammables-1"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:61')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-2"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:64')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-3"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:67')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-4"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:70')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-5"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:73')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-6"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:76')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["refined-flammables-7"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:79')
		flamer_buff(0.06, 0.06, force_name)
	end,
	["energy-weapons-damage"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:82')
		laser_buff(get_upgrade_modifier("laser-turret") * 2, force_name)
	end,
	["energy-weapons-damage-1"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:85')
		laser_buff(0.2, force_name)
	end,
	["energy-weapons-damage-2"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:88')
		laser_buff(0.2, force_name)
	end,
	["energy-weapons-damage-3"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:91')
		laser_buff(0.4, force_name)
	end,
	["energy-weapons-damage-4"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:94')
		laser_buff(0.4, force_name)
	end,
	["energy-weapons-damage-5"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:97')
		laser_buff(0.4, force_name)
	end,
	["energy-weapons-damage-6"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:100')
		laser_buff(0.5, force_name)
	end,
	["energy-weapons-damage-7"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:103')
		laser_buff(0.5, force_name)
	end,
	["stronger-explosives"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:106')
	...
	["stronger-explosives-1"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:121')
		if not global.combat_balance[force_name].land_mine then
			global.combat_balance[force_name].land_mine = get_ammo_modifier("landmine")
		end
		global.combat_balance[force_name].land_mine = global.combat_balance[force_name].land_mine
	...
	["physical-projectile-damage"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:129')
	...
	["physical-projectile-damage-1"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:138')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-2"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:141')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-3"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:144')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-4"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:147')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-5"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:150')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-6"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:153')
		proj_buff(0.3, force_name)
	end,
	["physical-projectile-damage-7"] = function(force_name)
		log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:156')
		proj_buff(0.3, force_name)
	end,
}
...
function Public.add_target_entity(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:208')
	if not entity then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:210')
		return
	end
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:213')
		return
	end
	if not target_entity_types[entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:216')
		return
	end
...
function Public.get_random_target_entity(force_index)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:221')
	...
	if size_of_target_entities == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:225')
		return
	end
	for _ = 1, size_of_target_entities, 1 do
		...
		if entity and entity.valid then
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:231')
			return entity
		else
			table_remove(target_entities, i)
			size_of_target_entities = size_of_target_entities - 1
			if size_of_target_entities == 0 then
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:236')
				return
			end
		end
	end
...
function Public.biters_landfill(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:242')
	if not landfill_biters[entity.name] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:244')
		return
	end
	local position = entity.position
	if math_abs(position.y) < 8 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:248')
		return true
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:268')
	return true
end

function Public.combat_balance(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:271')
...
function Public.init_player(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:286')
	if not player.connected then
		if player.force.index ~= 1 then
			player.force = game.forces.player
		end
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:291')
		return
	end
...
function Public.no_turret_creep(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:316')
	local entity = event.created_entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:319')
		return
	end
	if not no_turret_blacklist[event.created_entity.type] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:322')
		return
	end
	...
	if #spawners == 0 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:333')
		return
	end
	...
	if allowed_to_build then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:346')
		return
	end
...
function Public.no_landfill_by_untrusted_user(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:366')
	local entity = event.created_entity
	if not entity.valid or not event.player_index or entity.name ~= "tile-ghost" or entity.ghost_name ~= "landfill" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:369')
		return
	end
	...
	if not trusted[player.name] then
		...
		entity.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:376')
		return
	end
end
...
function Public.share_chat(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:381')
	if not event.message or not event.player_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:383')
		return
	end
	local player = game.players[event.player_index]
	...
	if global.tournament_mode and not player.admin then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:406')
		return
	end
	...
	if a then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:412')
		return
	end
...
function Public.spy_fish(player, event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:429')
	local button = event.button
	local shift = event.shift
	if not player.character then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:433')
		return
	end
	if event.control then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:436')
		return
	end
	local duration_per_unit = 2700
	local i2 = player.get_inventory(defines.inventory.character_main)
	if not i2 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:441')
		return
	end
...
function Public.create_map_intro_button(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:499')
	if player.gui.top["map_intro_button"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:501')
		return
	end
	local b =
		player.gui.top.add({ type = "sprite-button", caption = "?", name = "map_intro_button", tooltip = "Map Info" })
...
function Public.show_intro(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:510')
...
function Public.map_intro_click(player, element)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:521')
	if element.name == "close_map_intro_frame" then
		player.gui.center["map_intro_frame"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:524')
		return true
	end
	if element.name == "biter_battles_map_intro" then
		player.gui.center["map_intro_frame"].destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:528')
		return true
	end
	if element.name == "map_intro_button" then
		if player.gui.center["map_intro_frame"] then
			player.gui.center["map_intro_frame"].destroy()
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:533')
			return true
		else
			Public.show_intro(player)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:536')
			return true
		end
	end
end
...
function get_ammo_modifier(ammo_category)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:541')
	local result = 0
	if Tables.base_ammo_modifiers[ammo_category] then
		result = Tables.base_ammo_modifiers[ammo_category]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:546')
	return result
end
function get_turret_attack_modifier(turret_category)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:548')
	local result = 0
	if Tables.base_turret_attack_modifiers[turret_category] then
		result = Tables.base_turret_attack_modifiers[turret_category]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:553')
	return result
end

function get_upgrade_modifier(ammo_category)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:556')
	result = 0
	if Tables.upgrade_modifiers[ammo_category] then
		result = Tables.upgrade_modifiers[ammo_category]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:561')
	return result
end

log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/functions.lua:564')
return Public

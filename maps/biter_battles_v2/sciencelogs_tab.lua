...
local function initialize_dropdown_users_choice()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:14')
...
local function get_science_text(food_name, food_short_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:20')
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:21')
	return table.concat({
		"[img=item/",
		food_name,
		"][color=",
...
local function add_science_logs(player, element)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:32')
	...
	local t_summary =
		science_scrollpanel.add({ type = "table", name = "science_logs_summary_header_table", column_count = 8 })
...
function comfy_panel_get_active_frame(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:300')
	if not player.gui.left.comfy_panel then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:302')
		return false
	end
	if not player.gui.left.comfy_panel.tabbed_pane.selected_tab_index then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:305')
		return player.gui.left.comfy_panel.tabbed_pane.tabs[1].content
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:307')
...
local build_config_gui = function(player, frame)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:310')
	local frame_sciencelogs = comfy_panel_get_active_frame(player)
	if not frame_sciencelogs then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:313')
		return
	end
...
local function on_gui_selection_state_changed(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:319')
	local player = game.players[event.player_index]
	if not event.element.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/sciencelogs_tab.lua:322')
		return
	end

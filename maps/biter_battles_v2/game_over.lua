...
local function shuffle(tbl)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:18')
	local size = #tbl
	for i = size, 1, -1 do
		local rand = math.random(size)
		tbl[i], tbl[rand] = tbl[rand], tbl[i]
	end
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:24')
	return tbl
end

function Public.reveal_map()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:27')
...
local function create_victory_gui(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:34')
...
local function silo_kaboom(entity)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:54')
...
local function get_sorted_list(column_name, score_list)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:89')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:102')
	return score_list
end

local function get_mvps(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:105')
	local get_score = Score.get_table().score_table
	if not get_score[force] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:108')
		return false
	end
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:149')
	return mvp
end

local function show_mvps(player)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:152')
	local get_score = Score.get_table().score_table
	if not get_score then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:155')
		return
	end
	if player.gui.left["mvps"] then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:158')
		return
	end
	local frame = player.gui.left.add({
		type = "frame",
...
function Public.server_restart()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:276')
	if not global.server_restart_timer then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:278')
		return
	end
	...
	if global.server_restart_timer == 0 then
		if global.restart then
			if not global.announced_message then
				...
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:290')
				return
			end
		end
		if global.shutdown then
			if not global.announced_message then
				...
				global.announced_message = true
				log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:300')
				return
			end
		end
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:327')
		return
	end
...
local function set_victory_time()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:340')
...
local function freeze_all_biters(surface)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:356')
...
local function biter_killed_the_silo(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:365')
	local force = event.force
	if force ~= nil then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:368')
		return string.find(event.force.name, "_biters")
	end

	local cause = event.cause
	if cause ~= nil then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:373')
		return (cause.valid and cause.type == "unit")
	end

	log("Could not determine what destroyed the silo")
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:377')
	return false
end

local function respawn_silo(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:380')
	local entity = event.entity
	local surface = entity.surface
	if surface == nil or not surface.valid then
		log("Surface " .. global.bb_surface_name .. " invalid - cannot respawn silo")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:385')
		return
	end
...
function Public.silo_death(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:402')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:405')
		return
	end
	if entity.name ~= "rocket-silo" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:408')
		return
	end
	if global.bb_game_won_by_team then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:411')
		return
	end
	if entity == global.rocket_silo.south or entity == global.rocket_silo.north then
		...
		if not biter_killed_the_silo(event) then
			respawn_silo(event)
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:417')
			return
		end
...
local function chat_with_everyone(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:486')
	if not global.server_restart_timer then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:488')
		return
	end
	if not event.message then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:491')
		return
	end
	local player = game.get_player(event.player_index)
	if not player or not player.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:495')
		return
	end
	local enemy = Tables.enemy_team_of[player.force.name]
	if not enemy then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:499')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/game_over.lua:506')
return Public

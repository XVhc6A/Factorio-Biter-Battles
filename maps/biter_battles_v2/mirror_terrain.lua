...
local function clear_entities(surface, bb)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:18')
...
function Public.clone(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:30')
...
function Public.invert_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:67')
	...
	if destination.name == "character" then
		destination.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:74')
		return
	end
	...
	if src_pos.x == dest_pos.x and src_pos.y == dest_pos.y then
		destination.destroy()
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:104')
		return
	end
...
function Public.remove_hidden_tiles(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:112')
...
function Public.invert_tiles(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:130')
	local surface = event.destination_surface
...
function Public.invert_decoratives(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:154')
	local surface = event.destination_surface
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/mirror_terrain.lua:174')
return Public

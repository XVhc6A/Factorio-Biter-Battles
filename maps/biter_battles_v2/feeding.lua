...
function get_instant_threat_player_count_modifier()
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:13')
	...
	log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:20')
	return m
end

local function set_biter_endgame_modifiers(force)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:23')
	if force.evolution_factor ~= 1 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:25')
		return
	end
...
local function get_enemy_team_of(team)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:47')
	if global.training_mode then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:49')
		return team
	else
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:51')
		return enemy_team_of[team]
	end
end

local function print_feeding_msg(player, food, flask_amount)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:55')
	if not get_enemy_team_of(player.force.name) then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:57')
		return
	end
...
local function add_stats(	player,	food,	flask_amount,	biter_force_name,	evo_before_science_feed,	threat_before_science_feed)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:147')
	local colored_player_name = table.concat({
		"[color=",
		player.color.r * 0.6 + 0.35,
		",",
...
function set_evo_and_threat(flask_amount, food, biter_force_name)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:241')
	local decimals = 9
...
local function feed_biters(player, food)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:286')
	if game.ticks_played < global.difficulty_votes_timeout then
		player.print("Please wait for voting to finish before feeding")
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:289')
		return
	end
	...
	if flask_amount == 0 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:304')
		return
	end
...
log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/maps/biter_battles_v2/feeding.lua:322')
return feed_biters

...
local function place_scrap(surface, position)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:147')
	if math_random(1, 700) == 1 then
		if position.x ^ 2 + position.x ^ 2 > 4096 then
			...
			log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:152')
			return
		end
	end
	...
	if math_random(1, 128) == 1 then
		...
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:170')
		return
	end
...
local function is_scrap_area(noise)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:175')
	if noise > 0.25 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:177')
		return true
	end
	if noise < -0.25 then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:180')
		return true
	end
end

local function move_away_biteys(surface, area)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:184')
...
local function on_player_mined_entity(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:196')
	local entity = event.entity
	if not entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:199')
		return
	end
	if entity.name ~= "mineable-wreckage" then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:202')
		return
	end
...
local function on_entity_died(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:213')
	if not event.entity.valid then
		log('Func ret /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:215')
		return
	end
...
local function on_chunk_generated(event)
	log('Func start /Users/drbuttons/git/Factorio-Biter-Battles/terrain_layouts/scrap_01.lua:220')
			...
			if math_random(1, 3) > 1 then
				...
				if not surface.get_tile(position).collides_with("resource-layer") then
					...
					if is_scrap_area(noise) then
						surface.set_tiles(
							{ { name = "dirt-" .. math_floor(math_abs(noise) * 6) % 6 + 2, position = position } },
							true
						)
